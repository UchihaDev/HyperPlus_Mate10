...
extern const struct noc_bus_info noc_buses_info_kirin980_es[];
extern struct noc_mid_info noc_mid_kirin980_es[];
extern struct noc_dump_reg noc_dump_reg_list_kirin980_es[];
extern const struct noc_busid_initflow hisi_filter_initflow_kirin980_es[];
...
extern void hisi_noc_get_array_size_kirin970(unsigned int *bus_info_size,
					     unsigned int *dump_list_size);
extern void hisi_noc_get_array_size_kirin980_es(unsigned int *bus_info_size,
		                 unsigned int *dump_list_size);
...
extern unsigned int hisi_noc_clock_enable_kirin970_es(struct hisi_noc_device
						      *noc_dev,
						      struct noc_node *node);
extern unsigned int hisi_noc_clock_enable_kirin980_es(struct hisi_noc_device
		                      *noc_dev,
		                      struct noc_node *node);
