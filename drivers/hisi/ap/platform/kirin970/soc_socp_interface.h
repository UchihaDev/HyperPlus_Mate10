...
#define SOC_SOCP_ENC_SRC_BUFM_ADDR_L_ADDR(base,m) ((base) + (0x108+0x40*(m)))
#define SOC_SOCP_ENC_SRC_BUFM_ADDR_H_ADDR(base,m) ((base) + (0x10C+0x40*(m)))
#define SOC_SOCP_ENC_SRC_BUFM_DEPTH_ADDR(base,m) ((base) + (0x110+0x40*(m)))
#define SOC_SOCP_ENC_SRC_BUFM_CFG_ADDR(base,m) ((base) + (0x114+0x40*(m)))
#define SOC_SOCP_ENC_SRC_RDQ_WPTR_ADDR(base,m) ((base) + (0x118+0x40*(m)))
#define SOC_SOCP_ENC_SRC_RDQ_RPTR_ADDR(base,m) ((base) + (0x11C+0x40*(m)))
#define SOC_SOCP_ENC_SRC_RDQ_BADDR_L_ADDR(base,m) ((base) + (0x120+0x40*(m)))
#define SOC_SOCP_ENC_SRC_RDQ_BADDR_H_ADDR(base,m) ((base) + (0x124+0x40*(m)))
#define SOC_SOCP_ENC_SRC_RDQ_CFG_ADDR(base,m) ((base) + (0x128+0x40*(m)))
...
#define SOC_SOCP_ENC_DEST_BUFN_ADDR_L_ADDR(base,n) ((base) + (0x908+0x20*(n)))
#define SOC_SOCP_ENC_DEST_BUFN_ADDR_H_ADDR(base,n) ((base) + (0x90C+0x20*(n)))
#define SOC_SOCP_ENC_DEST_BUFN_DEPTH_ADDR(base,n) ((base) + (0x910+0x20*(n)))
#define SOC_SOCP_ENC_DEST_BUFN_THRH_ADDR(base,n) ((base) + (0x914+0x20*(n)))
#define SOC_SOCP_ENC_INT_THRESHOLD_ADDR(base,n) ((base) + (0x918+0x20*(n)))
#define SOC_SOCP_ENC_DEST_BUF_MODE_ADDR(base,n) ((base) + (0x91C+0x20*(n)))
#define SOC_SOCP_END_DEST_SB_CFG_ADDR(base,n) ((base) + (0x91C+0x20*(n)))
...
#define SOC_SOCP_DEC_SRC_BUFX_ADDR_L_ADDR(base,j) ((base) + (0xA08+0x40*(j)))
#define SOC_SOCP_DEC_SRC_BUFX_ADDR_H_ADDR(base,j) ((base) + (0xA0C+0x40*(j)))
#define SOC_SOCP_DEC_SRC_BUFX_CFG0_ADDR(base,j) ((base) + (0xA10+0x40*(j)))
#define SOC_SOCP_DEC_BUFX_STATUS0_ADDR(base,j) ((base) + (0xA14+0x40*(j)))
#define SOC_SOCP_DEC_BUFX_STATUS1_ADDR(base,j) ((base) + (0xA18+0x40*(j)))
#define SOC_SOCP_DEC_SRC_SB_CFG_ADDR(base,j) ((base) + (0xA28+0x40*(j)))
#define SOC_SOCP_DEC_DEST_SB_CFG_ADDR(base) ((base) + (0xA2C+0x40y))
#define SOC_SOCP_DEC_DEST_BUFY_WPTR_ADDR(base,y) ((base) + (0xC00+0x20*(y)))
#define SOC_SOCP_DEC_DEST_BUFY_RPTR_ADDR(base,y) ((base) + (0xC04+0x20*(y)))
#define SOC_SOCP_DEC_DEST_BUFY_ADDR_L_ADDR(base,y) ((base) + (0xC08+0x20*(y)))
#define SOC_SOCP_DEC_DEST_BUFY_ADDR_H_ADDR(base,y) ((base) + (0xC0C+0x20*(y)))
#define SOC_SOCP_DEC_DEST_BUFY_CFG0_ADDR(base,y) ((base) + (0xC10+0x20*(y)))
...
#define SOC_SOCP_GLOBAL_INT_STATUS_core0_enc_mode_switch_int_START (6)
#define SOC_SOCP_GLOBAL_INT_STATUS_core0_enc_mode_switch_int_END (6)
#define SOC_SOCP_GLOBAL_INT_STATUS_core1_enc_mode_switch_int_START (7)
#define SOC_SOCP_GLOBAL_INT_STATUS_core1_enc_mode_switch_int_END (7)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int core0_mode_switch_mask : 7;
...
#define SOC_SOCP_ENC_CORE0_MASK0_core0_mode_switch_mask_END (22)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        ...
        unsigned int reserved_0 : 9;
        unsigned int mode_switch_rawint : 7;
        unsigned int reserved_1 : 9;
    } reg;
...
#define SOC_SOCP_ENC_CORE0_RAWINT0_mode_switch_rawint_START (16)
#define SOC_SOCP_ENC_CORE0_RAWINT0_mode_switch_rawint_END (22)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        ...
        unsigned int reserved_0 : 9;
        unsigned int core0_mode_switch_maskint : 7;
        unsigned int reserved_1 : 9;
    } reg;
...
#define SOC_SOCP_ENC_CORE0_INT0_core0_mode_switch_maskint_END (22)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int reserved_0 : 9;
        unsigned int core1_mode_switch_mask : 7;
        unsigned int reserved_1 : 9;
    } reg;
...
#define SOC_SOCP_ENC_CORE1_MASK0_core1_mode_switch_mask_END (22)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        ...
        unsigned int reserved_0 : 9;
        unsigned int core1_mode_switch_maskint : 7;
        unsigned int reserved_1 : 9;
    } reg;
...
#define SOC_SOCP_ENC_CORE1_INT0_core1_mode_switch_maskint_END (22)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    {
        unsigned int : 15;
        unsigned int enc_src_bufm_addr_h : 17;
    } reg;
} SOC_SOCP_ENC_SRC_BUFM_ADDR_H_UNION;
#endif
#define SOC_SOCP_ENC_SRC_BUFM_ADDR_H__START (0)
#define SOC_SOCP_ENC_SRC_BUFM_ADDR_H__END (14)
#define SOC_SOCP_ENC_SRC_BUFM_ADDR_H_enc_src_bufm_addr_h_START (15)
#define SOC_SOCP_ENC_SRC_BUFM_ADDR_H_enc_src_bufm_addr_h_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int enc_src_sideband : 7;
...
#define SOC_SOCP_ENC_SRC_BUFM_CFG_enc_src_sideband_START (24)
#define SOC_SOCP_ENC_SRC_BUFM_CFG_enc_src_sideband_END (30)
...
typedef union
{
    ...
    {
        unsigned int : 15;
        unsigned int enc_bufm_rdq_baddr_h : 17;
    } reg;
} SOC_SOCP_ENC_SRC_RDQ_BADDR_H_UNION;
#endif
#define SOC_SOCP_ENC_SRC_RDQ_BADDR_H__START (0)
#define SOC_SOCP_ENC_SRC_RDQ_BADDR_H__END (14)
#define SOC_SOCP_ENC_SRC_RDQ_BADDR_H_enc_bufm_rdq_baddr_h_START (15)
#define SOC_SOCP_ENC_SRC_RDQ_BADDR_H_enc_bufm_rdq_baddr_h_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    {
        unsigned int : 15;
        unsigned int enc_dest_bufn_addr_h : 17;
    } reg;
} SOC_SOCP_ENC_DEST_BUFN_ADDR_H_UNION;
#endif
#define SOC_SOCP_ENC_DEST_BUFN_ADDR_H__START (0)
#define SOC_SOCP_ENC_DEST_BUFN_ADDR_H__END (14)
#define SOC_SOCP_ENC_DEST_BUFN_ADDR_H_enc_dest_bufn_addr_h_START (15)
#define SOC_SOCP_ENC_DEST_BUFN_ADDR_H_enc_dest_bufn_addr_h_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_SOCP_ENC_DEST_BUF_MODE_enc_dest_buf_mode_set_START (0)
#define SOC_SOCP_ENC_DEST_BUF_MODE_enc_dest_buf_mode_set_END (0)
#define SOC_SOCP_ENC_DEST_BUF_MODE_enc_dest_buf_mode_state_START (1)
#define SOC_SOCP_ENC_DEST_BUF_MODE_enc_dest_buf_mode_state_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int enc_dest_sideband : 7;
        unsigned int reserved : 25;
    } reg;
} SOC_SOCP_END_DEST_SB_CFG_UNION;
#endif
#define SOC_SOCP_END_DEST_SB_CFG_enc_dest_sideband_START (0)
#define SOC_SOCP_END_DEST_SB_CFG_enc_dest_sideband_END (6)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    {
        unsigned int : 15;
        unsigned int dec_src_bufx_addr_h : 17;
    } reg;
} SOC_SOCP_DEC_SRC_BUFX_ADDR_H_UNION;
#endif
#define SOC_SOCP_DEC_SRC_BUFX_ADDR_H__START (0)
#define SOC_SOCP_DEC_SRC_BUFX_ADDR_H__END (14)
#define SOC_SOCP_DEC_SRC_BUFX_ADDR_H_dec_src_bufx_addr_h_START (15)
#define SOC_SOCP_DEC_SRC_BUFX_ADDR_H_dec_src_bufx_addr_h_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        unsigned int dec_src_sideband : 7;
        unsigned int reserved : 25;
    } reg;
} SOC_SOCP_DEC_SRC_SB_CFG_UNION;
#endif
#define SOC_SOCP_DEC_SRC_SB_CFG_dec_src_sideband_START (0)
#define SOC_SOCP_DEC_SRC_SB_CFG_dec_src_sideband_END (6)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int dec_dest_buf0_sideband : 7;
        unsigned int reserved_0 : 1;
        unsigned int dec_dest_buf1_sideband : 7;
        unsigned int reserved_1 : 1;
        unsigned int dec_dest_buf2_sideband : 7;
        unsigned int reserved_2 : 1;
        unsigned int dec_dest_buf3_sideband : 7;
        unsigned int reserved_3 : 1;
    } reg;
} SOC_SOCP_DEC_DEST_SB_CFG_UNION;
#endif
#define SOC_SOCP_DEC_DEST_SB_CFG_dec_dest_buf0_sideband_START (0)
#define SOC_SOCP_DEC_DEST_SB_CFG_dec_dest_buf0_sideband_END (6)
#define SOC_SOCP_DEC_DEST_SB_CFG_dec_dest_buf1_sideband_START (8)
#define SOC_SOCP_DEC_DEST_SB_CFG_dec_dest_buf1_sideband_END (14)
#define SOC_SOCP_DEC_DEST_SB_CFG_dec_dest_buf2_sideband_START (16)
#define SOC_SOCP_DEC_DEST_SB_CFG_dec_dest_buf2_sideband_END (22)
#define SOC_SOCP_DEC_DEST_SB_CFG_dec_dest_buf3_sideband_START (24)
#define SOC_SOCP_DEC_DEST_SB_CFG_dec_dest_buf3_sideband_END (30)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    {
        unsigned int : 15;
        unsigned int dec_dest_bufy_addr_h : 17;
    } reg;
} SOC_SOCP_DEC_DEST_BUFY_ADDR_H_UNION;
#endif
#define SOC_SOCP_DEC_DEST_BUFY_ADDR_H__START (0)
#define SOC_SOCP_DEC_DEST_BUFY_ADDR_H__END (14)
#define SOC_SOCP_DEC_DEST_BUFY_ADDR_H_dec_dest_bufy_addr_h_START (15)
#define SOC_SOCP_DEC_DEST_BUFY_ADDR_H_dec_dest_bufy_addr_h_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
