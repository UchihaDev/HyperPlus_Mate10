...
#define SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_ADDR(base,chans) ((base) + (0x200+0x4*(chans)))
#define SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_ADDR(base,chans,rnks) ((base) + (0x210+0x40*(chans)+0x4*(rnks)))
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_ADDR(base,chans) ((base) + (0x2A0+4*(chans)))
...
#define SOC_DDRC_QOSB_QOSB_WBUF_CTRL_wbuf_rw_lvl_START (16)
#define SOC_DDRC_QOSB_QOSB_WBUF_CTRL_wbuf_rw_lvl_END (20)
...
typedef union
{
    ...
    struct
    {
        unsigned int wbuf_rdtimout : 16;
        unsigned int wbuf_wrtimout : 16;
    } reg;
} SOC_DDRC_QOSB_QOSB_WBUF_PRI_CTRL_UNION;
#endif
#define SOC_DDRC_QOSB_QOSB_WBUF_PRI_CTRL_wbuf_rdtimout_START (0)
#define SOC_DDRC_QOSB_QOSB_WBUF_PRI_CTRL_wbuf_rdtimout_END (15)
#define SOC_DDRC_QOSB_QOSB_WBUF_PRI_CTRL_wbuf_wrtimout_START (16)
#define SOC_DDRC_QOSB_QOSB_WBUF_PRI_CTRL_wbuf_wrtimout_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_UNION;
#endif
#define SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_int_admap_START (0)
#define SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_int_admap_END (0)
#define SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_mem_width_START (4)
#define SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_mem_width_END (5)
#define SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_rank_mode_START (18)
#define SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_rank_mode_END (19)
#define SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_rank_START (20)
#define SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_rank_END (21)
#define SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_bank_xor_START (24)
#define SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_bank_xor_END (26)
#define SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_bank_mode_START (28)
#define SOC_DDRC_QOSB_QOSB_CFG_DDRMODE_bank_mode_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_UNION;
#endif
#define SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_mem_col_START (0)
#define SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_mem_col_END (2)
#define SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_mem_row_START (4)
#define SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_mem_row_END (6)
#define SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_mem_bank_START (8)
#define SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_mem_bank_END (9)
#define SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_mem_bankgroup_START (10)
#define SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_mem_bankgroup_END (11)
#define SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_mem_map_START (12)
#define SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_mem_map_END (13)
#define SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_mem_x4_START (16)
#define SOC_DDRC_QOSB_QOSB_CFG_RNKVOL_mem_x4_END (16)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int region0 : 3;
        unsigned int reserved_0: 1;
        unsigned int region1 : 3;
        unsigned int reserved_1: 1;
        unsigned int region2 : 3;
        unsigned int reserved_2: 1;
        unsigned int region3 : 3;
        unsigned int reserved_3: 1;
        unsigned int region4 : 3;
        unsigned int reserved_4: 1;
        unsigned int region5 : 3;
        unsigned int reserved_5: 1;
        unsigned int region6 : 3;
        unsigned int reserved_6: 1;
        unsigned int region7 : 3;
        unsigned int reserved_7: 1;
    } reg;
} SOC_DDRC_QOSB_QOSB_REMAP_CTRL_UNION;
#endif
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region0_START (0)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region0_END (2)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region1_START (4)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region1_END (6)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region2_START (8)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region2_END (10)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region3_START (12)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region3_END (14)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region4_START (16)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region4_END (18)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region5_START (20)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region5_END (22)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region6_START (24)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region6_END (26)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region7_START (28)
#define SOC_DDRC_QOSB_QOSB_REMAP_CTRL_region7_END (30)
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
