...
#define SOC_ISP_TNR_CONFIG_first_START (1)
#define SOC_ISP_TNR_CONFIG_first_END (1)
#define SOC_ISP_TNR_CONFIG_color_mode_START (2)
#define SOC_ISP_TNR_CONFIG_color_mode_END (2)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int global_thd : 8;
        unsigned int global_thd_uv : 8;
        unsigned int alphaiir_offset_y : 8;
        unsigned int alphaiir_offset_uv : 8;
    } reg;
} SOC_ISP_TNR_THD_CFG_UNION;
#endif
#define SOC_ISP_TNR_THD_CFG_global_thd_START (0)
#define SOC_ISP_TNR_THD_CFG_global_thd_END (7)
#define SOC_ISP_TNR_THD_CFG_global_thd_uv_START (8)
#define SOC_ISP_TNR_THD_CFG_global_thd_uv_END (15)
#define SOC_ISP_TNR_THD_CFG_alphaiir_offset_y_START (16)
#define SOC_ISP_TNR_THD_CFG_alphaiir_offset_y_END (23)
#define SOC_ISP_TNR_THD_CFG_alphaiir_offset_uv_START (24)
#define SOC_ISP_TNR_THD_CFG_alphaiir_offset_uv_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_ISP_TNR_CROP_ihright_END (9)
