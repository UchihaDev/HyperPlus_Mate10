...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int iomcu_rsten0_25_h_tcp : 1;
        unsigned int iomcu_rsten0_26_p_tcp : 1;
        unsigned int iomcu_rsten0_27i2c6 : 1;
        unsigned int iomcu_rsten0_28reseved : 1;
...
#define SOC_IOMCU_RSTEN0_iomcu_rsten0_25_h_tcp_START (25)
#define SOC_IOMCU_RSTEN0_iomcu_rsten0_25_h_tcp_END (25)
...
#define SOC_IOMCU_RSTEN0_iomcu_rsten0_28reseved_START (28)
#define SOC_IOMCU_RSTEN0_iomcu_rsten0_28reseved_END (28)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int iomcu_rstdis0_25_h_tcp : 1;
        unsigned int iomcu_rstdis0_26_p_tcp : 1;
        unsigned int iomcu_rstdis0_27i2c6 : 1;
        unsigned int iomcu_rstdis0_28reseved : 1;
...
#define SOC_IOMCU_RSTDIS0_iomcu_rstdis0_25_h_tcp_START (25)
#define SOC_IOMCU_RSTDIS0_iomcu_rstdis0_25_h_tcp_END (25)
...
#define SOC_IOMCU_RSTDIS0_iomcu_rstdis0_28reseved_START (28)
#define SOC_IOMCU_RSTDIS0_iomcu_rstdis0_28reseved_END (28)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int iomcu_rststats0_25_h_tcp : 1;
        unsigned int iomcu_rststats0_26_p_tcp : 1;
        unsigned int iomcu_rststats0_27i2c6 : 1;
        unsigned int iomcu_rststats0_28reseved : 1;
...
#define SOC_IOMCU_RSTSTAT0_iomcu_rststats0_25_h_tcp_START (25)
#define SOC_IOMCU_RSTSTAT0_iomcu_rststats0_25_h_tcp_END (25)
...
#define SOC_IOMCU_RSTSTAT0_iomcu_rststats0_28reseved_START (28)
#define SOC_IOMCU_RSTSTAT0_iomcu_rststats0_28reseved_END (28)
...
typedef union
{
    ...
    struct
    {
        unsigned int tcm_wtsel_spmb : 2;
        unsigned int tcm_rtsel_spmb : 2;
        unsigned int tcm_wtsel_spsb : 2;
        unsigned int tcm_rtsel_spsb : 2;
        unsigned int cache_wtsel_spmb : 2;
        unsigned int cache_rtsel_spmb : 2;
        unsigned int cache_wtsel_spsb : 2;
        unsigned int cache_rtsel_spsb : 2;
        unsigned int mem_ctrl_i3c : 16;
    } reg;
} SOC_IOMCU_MEM_CTRL2_UNION;
#endif
#define SOC_IOMCU_MEM_CTRL2_tcm_wtsel_spmb_START (0)
#define SOC_IOMCU_MEM_CTRL2_tcm_wtsel_spmb_END (1)
#define SOC_IOMCU_MEM_CTRL2_tcm_rtsel_spmb_START (2)
#define SOC_IOMCU_MEM_CTRL2_tcm_rtsel_spmb_END (3)
#define SOC_IOMCU_MEM_CTRL2_tcm_wtsel_spsb_START (4)
#define SOC_IOMCU_MEM_CTRL2_tcm_wtsel_spsb_END (5)
#define SOC_IOMCU_MEM_CTRL2_tcm_rtsel_spsb_START (6)
#define SOC_IOMCU_MEM_CTRL2_tcm_rtsel_spsb_END (7)
#define SOC_IOMCU_MEM_CTRL2_cache_wtsel_spmb_START (8)
#define SOC_IOMCU_MEM_CTRL2_cache_wtsel_spmb_END (9)
#define SOC_IOMCU_MEM_CTRL2_cache_rtsel_spmb_START (10)
#define SOC_IOMCU_MEM_CTRL2_cache_rtsel_spmb_END (11)
#define SOC_IOMCU_MEM_CTRL2_cache_wtsel_spsb_START (12)
#define SOC_IOMCU_MEM_CTRL2_cache_wtsel_spsb_END (13)
#define SOC_IOMCU_MEM_CTRL2_cache_rtsel_spsb_START (14)
#define SOC_IOMCU_MEM_CTRL2_cache_rtsel_spsb_END (15)
#define SOC_IOMCU_MEM_CTRL2_mem_ctrl_i3c_START (16)
#define SOC_IOMCU_MEM_CTRL2_mem_ctrl_i3c_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IOMCU_TCP_CTRL_tcp_mem_ctrl_END (11)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
