...
#ifndef __VDM_HAL_AVS_H__
#define __VDM_HAL_AVS_H__
...
SINT32 AVSHAL_InitHal(UADDR CodeTabAddr);
SINT32 AVSHAL_StartDec(AVS_DEC_PARAM_S *pAvsDecParam, SINT32 VdhId);
