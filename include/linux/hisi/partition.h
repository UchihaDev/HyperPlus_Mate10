...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_TRUSTFIRMWARE_A,  634*1024,  2*1024,        EMMC_USER_PART},/* trustfirmware   2M     p48*/
  {PART_MODEM_FW_A,       636*1024,  56*1024,       EMMC_USER_PART},/* modem_fw        56M    p49*/
  {PART_RESERVED4_A,      692*1024,  24*1024,       EMMC_USER_PART},/* reserved4A      24M    p50*/
  {PART_VBMETA_A,        716*1024,  4*1024,       EMMC_USER_PART},/* PART_VBMETA_A      4M    p51*/
  {PART_MODEMNVM_UPDATE_A,720*1024,  16*1024,       EMMC_USER_PART},/* modemnvm update 16M    p52*/
  {PART_MODEMNVM_CUST_A,736*1024,  40*1024,       EMMC_USER_PART},/* modemnvm update cust 64M p53*/
  {PART_PATCH_A,          776 *1024,  32*1024,      EMMC_USER_PART},/* patch           16M    p54*/
  {PART_VERSION_A,        808*1024,  32*1024,       EMMC_USER_PART},/* version         8M     p55*/
  {PART_VENDOR_A,         840*1024,  784*1024,      EMMC_USER_PART},/* vendor          704M   p56*/
  {PART_PRODUCT_A,        1624*1024, 192*1024,      EMMC_USER_PART},/* product         240M   p57*/
  {PART_CUST_A,           1816*1024, 192*1024,      EMMC_USER_PART},/* cust            256M   p58*/
  {PART_ODM_A,            2008*1024,  128*1024,     EMMC_USER_PART},/* odm           128M     p59*/
  {PART_CACHE,            2136*1024,  128*1024,     EMMC_USER_PART},/* cache           256M   p60*/
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         2264*1024, 3852*1024,     EMMC_USER_PART},/* system          3697M  p61*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        6116*1024, 128*1024,       EMMC_USER_PART},/* reserved5       128M  p62*/
  {PART_HIBENCH_DATA,   6244*1024, 512*1024,       EMMC_USER_PART},/* hibench_data      512M  p63*/
  {PART_USERDATA,         6756*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G     p64*/
  #else
  {PART_USERDATA,         6116*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G     p64*/
  #endif
  #else
  {PART_SYSTEM_A,         2264*1024, 4988*1024,     EMMC_USER_PART},/* system          4000M  p61*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        7252*1024, 128*1024,       EMMC_USER_PART},/* reserved5       64M    p62*/
  {PART_HIBENCH_DATA,   7380*1024, 512*1024,       EMMC_USER_PART},/* hibench_data      512M   p63*/
  {PART_USERDATA,         7892*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata         4G    p64*/
  #else
  {PART_USERDATA,         7252*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata         4G    p62*/
  #endif
  #endif
  {"0", 0, 0, 0},                                        /* total 11848M*/
};
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_TRUSTFIRMWARE_A,  626*1024,  2*1024,        UFS_PART_3},/* trustfirmware   2M     p44*/
  {PART_MODEM_FW_A,       628*1024,  56*1024,       UFS_PART_3},/* modem_fw        56M    p45*/
  {PART_RESERVED4_A,      684*1024,  24*1024,       UFS_PART_3},/* reserved4A      24M    p46*/
  {PART_VBMETA_A,         708*1024,  4*1024,        UFS_PART_3},/* reserved4A       4M    p47*/
  {PART_MODEMNVM_UPDATE_A,712*1024,  16*1024,       UFS_PART_3},/* modemnvm update 16M    p48*/
  {PART_MODEMNVM_CUST_A,728*1024,  40*1024,       UFS_PART_3},/* modemnvm update cust 64M p49*/
  {PART_PATCH_A,          768*1024,  32*1024,       UFS_PART_3},/* patch           32M    p50*/
  {PART_VERSION_A,        800*1024,  32*1024,       UFS_PART_3},/* version        24M     p51*/
  {PART_VENDOR_A,         832*1024,  784*1024,      UFS_PART_3},/* vendor          784M   p52*/
  {PART_PRODUCT_A,        1616*1024, 192*1024,      UFS_PART_3},/* product         192M   p53*/
  {PART_CUST_A,           1808*1024, 192*1024,      UFS_PART_3},/* cust            192M   p54*/
  {PART_ODM_A,            2000*1024,  128*1024,     UFS_PART_3},/* odm           128M     p55*/
  {PART_CACHE,            2128*1024,  128*1024,     UFS_PART_3},/* cache           128M   p56*/
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         2256*1024, 3852*1024,     UFS_PART_3},/* system          3552M  p57*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        6108*1024, 128*1024,      UFS_PART_3},/* reserved5       128M   p58*/
  {PART_HIBENCH_DATA,     6236*1024, 512*1024,      UFS_PART_3},/* hibench_data   512M    p59*/
  {PART_USERDATA,         6748*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p60*/
  #else
  {PART_USERDATA,         6108*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p60*/
  #endif
  #else
  {PART_SYSTEM_A,         2256*1024, 4988*1024,     UFS_PART_3},/* system          4688M  p57*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        7244*1024, 128*1024,       UFS_PART_3},/* reserved5      128M   p58*/
  {PART_HIBENCH_DATA,   7372*1024, 512*1024,       UFS_PART_3},/* hibench_data     512M   p59*/
  {PART_USERDATA,         7884*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p60*/
  #else
  {PART_USERDATA,         7244*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p60*/
  #endif
  #endif
  {"0", 0, 0, 0},
};
...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_USERDATA,         7892*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata         4G    p64*/
  #else
  {PART_USERDATA,         7252*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata         4G    p64*/
  #endif
  #endif
  {"0", 0, 0, 0},                                        /* total 11848M*/
};
