...
static int hi6403_platform_probe(struct platform_device *pdev)
{
	...
	if (!match) {
		...
		dev_info(dev, "%s : mic_num %d , use_stereo_smartpa %d, classh_rcv_hp_switch %d, hp_high_low_change_enable %d, hp_res_detect_enable %d, extern_hs_hifi_ak4376_I2S3 %d, gpio_pd_enable %d, ir_gpio_id %u hsd_cfg_enable %d\n",
