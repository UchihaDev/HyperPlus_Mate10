...
extern int hisi_blk_mq_complete_request(struct request *rq,struct request_queue *q);
...
static inline int hisi_blk_mq_complete_request(struct request *rq,struct request_queue *q){return 0;};
