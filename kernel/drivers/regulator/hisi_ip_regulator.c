...
#elif defined CONFIG_KIRIN980_IP_PLATFORM
enum ip_regulator_id {
	MEDIA1_SUBSYS_ID = 0,
	MEDIA2_SUBSYS_ID,
	VIVOBUS_ID,
...
#endif
#if defined (CONFIG_KIRIN970_IP_PLATFORM) || defined(CONFIG_KIRIN660_IP_PLATFORM) || defined(CONFIG_KIRIN980_IP_PLATFORM)
...
int hisi_regulator_freq_autodown_clk(int regulator_id, u32 flag)
{
	...
	case IVP_ID:
		...
		break;
#if defined(CONFIG_KIRIN980_IP_PLATFORM)
	case ICS_ID:
