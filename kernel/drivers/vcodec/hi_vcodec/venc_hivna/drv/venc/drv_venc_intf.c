...
static const struct of_device_id venc_of_match[] = {
	{ .compatible = "hisi,kirin980-venc", },/*lint !e785 */
	{ }/*lint !e785 */
};
#endif
...
static HI_S32 VENC_DRV_Probe(struct platform_device * pltdev)
{
	...
	if(fpga_es == 1)
	{
		printk(KERN_INFO "ATLANTA es fpga\n");
		if (VENC_DRV_Device_Idle(KIRIN_980) == HI_FALSE)
		{
			printk(KERN_ERR "ATLANTA_ES, venc is not exist\n");
			return HI_FAILURE;
		}
	}
	else
	{
		printk(KERN_INFO "not Atlanta es fpga\n");
	}
#endif
