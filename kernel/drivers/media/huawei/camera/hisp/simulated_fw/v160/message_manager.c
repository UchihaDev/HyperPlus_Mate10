...
#include "sensor/simulated_cis_if.h"
#include "sensor/simulated_cis_imx286dual.h"
#include "sensor/simulated_cis_imx286hybird_udp_es.h"
#include "sensor/simulated_cis_ov8865_udp_es.h"
...
simulated_fw_camera_info_t simulated_fw_camera_info[] = {
	{
	 ...
	 .get_capability = imx286hybird_udp_es_cis_get_capability,
	 .usecase_config = {0},
	 },
	{
	 .handle = 0,
	 ...
	 .sensor_name = "OV8865",
	 .status = CAMERA_CLOSED,
	 .get_capability = ov8865_udp_es_cis_get_capability,
	 .usecase_config = {0},
	 },
	{
	 .handle = 0,
...
int simulated_fw_extend_set(void *isp_msg_r)
{
	...
	if (isp_msg->u.req_extend_set.extend_cmd == SUBCMD_SET_RGB2YUV_PARAM) {
