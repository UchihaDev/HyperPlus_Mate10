...
#define CHROMA_GRID_SIZEH        17
#define CHROMA_GRID_SIZEW        17
#define GRAY_SEGM_NUM            9
#define CE_EXIF_SAT_NUM          4
#define CE_HIST_STAT_INFO_NUM    3
#define CE_HS_OPTIM_NUM          4
// add for gamma
#define TONE_CURVE_LEN          257
#define GAMMA_CALIBRATION_SIZE  257
#define GAMMA_CURVE_HW_SIZE     96
...
typedef struct exposure_param_struct
{
    ...
    unsigned int base_expo;//for motion scene, used by slf
