...
typedef struct _sharpenARSR_manual_cfg_t
{
    unsigned int use_manual;
    unsigned int sharpenArsr_switch[ALGO_SWITCH_LEN];
    arsr_sharpen_manual_cfg_t sharpenArsrCfg;
}sharpenARSR_manual_cfg_t;
...
typedef struct
{
    ...
    unsigned char  LineThd1;
    unsigned char  LineThd2;
} sharpen_reg_filter_t;

typedef struct _sharpen_reg_t
{
    unsigned int use_manual;
    int sharpen_switch[ALGO_SWITCH_LEN];
    sharpen_reg_filter_t sharpenCfg;
} sharpen_reg_t;
