...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int shootsel : 2;
        unsigned int sharpsel : 1;
        unsigned int reserved : 5;
        unsigned int dir_scale : 8;
    } reg;
...
#define SOC_ISP_SHARPEN_SHOOTCFG_shootsel_START (16)
#define SOC_ISP_SHARPEN_SHOOTCFG_shootsel_END (17)
#define SOC_ISP_SHARPEN_SHOOTCFG_sharpsel_START (18)
#define SOC_ISP_SHARPEN_SHOOTCFG_sharpsel_END (18)
#define SOC_ISP_SHARPEN_SHOOTCFG_dir_scale_START (24)
#define SOC_ISP_SHARPEN_SHOOTCFG_dir_scale_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
