...
typedef union
{
    ...
    struct
    {
        unsigned int fl_maxp : 18;
        unsigned int reserved : 14;
    } reg;
} SOC_ISP_FLASH_MAXP_UNION;
#endif
#define SOC_ISP_FLASH_MAXP_fl_maxp_START (0)
#define SOC_ISP_FLASH_MAXP_fl_maxp_END (17)
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
