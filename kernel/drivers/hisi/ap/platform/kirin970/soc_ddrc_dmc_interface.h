...
#define SOC_DDRC_DMC_DDRC_CFG_OP_SWITCH_ADDR(base) ((base) + (0x03C))
...
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_ADDR(base) ((base) + (0x0F0))
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_ADDR(base) ((base) + (0x0F4))
#define SOC_DDRC_DMC_DDRC_CFG_TIM_BAK0_ADDR(base) ((base) + (0x0F8))
#define SOC_DDRC_DMC_DDRC_CFG_TIM_BAK1_ADDR(base) ((base) + (0x0FC))
...
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME0_ADDR(base) ((base) + (0x230))
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME1_ADDR(base) ((base) + (0x234))
...
#define SOC_DDRC_DMC_DDRC_CFG_LP_DYN_ADDR(base) ((base) + (0x560))
#define SOC_DDRC_DMC_DDRC_CFG_LP_L2_IDLE_ADDR(base) ((base) + (0x564))
#define SOC_DDRC_DMC_DDRC_CFG_LP_L3_IDLE_ADDR(base) ((base) + (0x568))
...
#define SOC_DDRC_DMC_DDRC_HIS_DDR_RCMD_BL32_ADDR(base) ((base) + (0x600))
#define SOC_DDRC_DMC_DDRC_HIS_DDR_WCMD_BL32_ADDR(base) ((base) + (0x604))
#define SOC_DDRC_DMC_DDRC_HIS_DDR_RCMD_ADDR(base) ((base) + (0x608))
#define SOC_DDRC_DMC_DDRC_HIS_DDR_WCMD_ADDR(base) ((base) + (0x60c))
#define SOC_DDRC_DMC_DDRC_HIS_REF_CMD_ADDR(base) ((base) + (0x610))
#define SOC_DDRC_DMC_DDRC_HIS_PD_CNT_ADDR(base) ((base) + (0x614))
#define SOC_DDRC_DMC_DDRC_HIS_ACT_PD_CNT_ADDR(base) ((base) + (0x618))
#define SOC_DDRC_DMC_DDRC_HIS_ACT_NPD_CNT_ADDR(base) ((base) + (0x61c))
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_CTRL_ADDR(base) ((base) + (0xfc0))
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INTMSK_ADDR(base) ((base) + (0xfc4))
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_RINT_ADDR(base) ((base) + (0xfc8))
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INTSTS_ADDR(base) ((base) + (0xfcc))
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INFO_INDEX_ADDR(base) ((base) + (0xfd0))
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INFO_ADDR(base) ((base) + (0xfd4))
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_ADDR(base) ((base) + (0xfe0))
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA1_ADDR(base) ((base) + (0xfe4))
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL5_ADDR(base) ((base) + (0xfe8))
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_ADDR(base) ((base) + (0xfec))
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL0_ADDR(base) ((base) + (0xff0))
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_ADDR(base) ((base) + (0xff4))
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_ADDR(base) ((base) + (0xff8))
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_ADDR(base) ((base) + (0xffc))
...
#define SOC_DDRC_DMC_DDRC_CTRL_SREF_asref_en_START (16)
#define SOC_DDRC_DMC_DDRC_CTRL_SREF_asref_en_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int sys_lp_cnt : 12;
    } reg;
} SOC_DDRC_DMC_DDRC_CFG_LP_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_CFG_LP_lp_en_START (0)
#define SOC_DDRC_DMC_DDRC_CFG_LP_lp_en_END (0)
#define SOC_DDRC_DMC_DDRC_CFG_LP_sys_gt_en_START (1)
#define SOC_DDRC_DMC_DDRC_CFG_LP_sys_gt_en_END (1)
...
#define SOC_DDRC_DMC_DDRC_CFG_LP_sys_lp_cnt_START (20)
#define SOC_DDRC_DMC_DDRC_CFG_LP_sys_lp_cnt_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_DDRC_DMC_DDRC_CFG_SREF_sref_flush_en_START (5)
#define SOC_DDRC_DMC_DDRC_CFG_SREF_sref_flush_en_END (5)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int pstpnd_level : 3;
        unsigned int aref_alarm_num : 8;
        unsigned int phyupd_level : 3;
        unsigned int reserved_1 : 1;
        unsigned int modified_mode : 1;
        unsigned int aref_rate_ext : 1;
        unsigned int aref_ch_mode : 1;
        unsigned int aref_0p5trefi : 1;
...
#define SOC_DDRC_DMC_DDRC_CFG_AREF_pstpnd_level_END (7)
...
#define SOC_DDRC_DMC_DDRC_CFG_AREF_phyupd_level_END (18)
#define SOC_DDRC_DMC_DDRC_CFG_AREF_modified_mode_START (20)
#define SOC_DDRC_DMC_DDRC_CFG_AREF_modified_mode_END (20)
#define SOC_DDRC_DMC_DDRC_CFG_AREF_aref_rate_ext_START (21)
#define SOC_DDRC_DMC_DDRC_CFG_AREF_aref_rate_ext_END (21)
#define SOC_DDRC_DMC_DDRC_CFG_AREF_aref_ch_mode_START (22)
#define SOC_DDRC_DMC_DDRC_CFG_AREF_aref_ch_mode_END (22)
#define SOC_DDRC_DMC_DDRC_CFG_AREF_aref_0p5trefi_START (23)
#define SOC_DDRC_DMC_DDRC_CFG_AREF_aref_0p5trefi_END (23)
#define SOC_DDRC_DMC_DDRC_CFG_AREF_aref_comp_START (24)
#define SOC_DDRC_DMC_DDRC_CFG_AREF_aref_comp_END (24)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        unsigned int op_switch : 1;
        unsigned int reserved : 31;
    } reg;
} SOC_DDRC_DMC_DDRC_CFG_OP_SWITCH_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_CFG_OP_SWITCH_op_switch_START (0)
#define SOC_DDRC_DMC_DDRC_CFG_OP_SWITCH_op_switch_END (0)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_DDRC_DMC_DDRC_CFG_WORKMODE_osc_retrain_en_START (0)
#define SOC_DDRC_DMC_DDRC_CFG_WORKMODE_osc_retrain_en_END (0)
...
#define SOC_DDRC_DMC_DDRC_CFG_WORKMODE_global_clkon_START (6)
#define SOC_DDRC_DMC_DDRC_CFG_WORKMODE_global_clkon_END (6)
...
#define SOC_DDRC_DMC_DDRC_CFG_WORKMODE_mid_push_en_START (15)
#define SOC_DDRC_DMC_DDRC_CFG_WORKMODE_mid_push_en_END (15)
...
#define SOC_DDRC_DMC_DDRC_CFG_DDRMODE_zq_ch_mode_START (8)
#define SOC_DDRC_DMC_DDRC_CFG_DDRMODE_zq_ch_mode_END (8)
#define SOC_DDRC_DMC_DDRC_CFG_DDRMODE_wr_2t_pre_START (9)
#define SOC_DDRC_DMC_DDRC_CFG_DDRMODE_wr_2t_pre_END (9)
#define SOC_DDRC_DMC_DDRC_CFG_DDRMODE_wr_3t_pre_START (10)
#define SOC_DDRC_DMC_DDRC_CFG_DDRMODE_wr_3t_pre_END (10)
...
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_clk_ratio_END (0)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_clk_ratio2_START (1)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_clk_ratio2_END (1)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_brstlen_START (2)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_brstlen_END (2)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_brstlen2_START (3)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_brstlen2_END (3)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_lpddr4_bl32_START (4)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_lpddr4_bl32_END (4)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_wr_otf_en_START (5)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_wr_otf_en_END (5)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_rd_otf_en_START (6)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_rd_otf_en_END (6)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_rd_dbi_en_START (7)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_rd_dbi_en_END (7)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_wr_dbi_en_START (8)
#define SOC_DDRC_DMC_DDRC_CFG_DDRVMODE_wr_dbi_en_END (8)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_clk_ratio_START (0)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_clk_ratio_END (0)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_clk_ratio2_START (1)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_clk_ratio2_END (1)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_brstlen_START (2)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_brstlen_END (2)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_brstlen2_START (3)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_brstlen2_END (3)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_lpddr4_bl32_START (4)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_lpddr4_bl32_END (4)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_wr_otf_en_START (5)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_wr_otf_en_END (5)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_rd_otf_en_START (6)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_rd_otf_en_END (6)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_rd_dbi_en_START (7)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_rd_dbi_en_END (7)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_wr_dbi_en_START (8)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_DDRVMODE_wr_dbi_en_END (8)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int trmrw : 6;
        unsigned int reserved_0: 2;
        unsigned int trapmrw : 6;
        unsigned int reserved_1: 2;
...
#define SOC_DDRC_DMC_DDRC_CFG_TIM_BAK0_trmrw_END (5)
#define SOC_DDRC_DMC_DDRC_CFG_TIM_BAK0_trapmrw_START (8)
#define SOC_DDRC_DMC_DDRC_CFG_TIM_BAK0_trapmrw_END (13)
#define SOC_DDRC_DMC_DDRC_CFG_TIM_BAK0_trtrrd_START (16)
#define SOC_DDRC_DMC_DDRC_CFG_TIM_BAK0_trtrrd_END (21)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int twmrw : 6;
        unsigned int reserved_0: 2;
        unsigned int twapmrw : 6;
        unsigned int reserved_1: 2;
        unsigned int twrwtr : 6;
        unsigned int reserved_2: 10;
    } reg;
} SOC_DDRC_DMC_DDRC_CFG_TIM_BAK1_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_CFG_TIM_BAK1_twmrw_START (0)
#define SOC_DDRC_DMC_DDRC_CFG_TIM_BAK1_twmrw_END (5)
#define SOC_DDRC_DMC_DDRC_CFG_TIM_BAK1_twapmrw_START (8)
#define SOC_DDRC_DMC_DDRC_CFG_TIM_BAK1_twapmrw_END (13)
#define SOC_DDRC_DMC_DDRC_CFG_TIM_BAK1_twrwtr_START (16)
#define SOC_DDRC_DMC_DDRC_CFG_TIM_BAK1_twrwtr_END (21)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_DDRC_DMC_DDRC_CFG_TIMING0_tmrw_START (28)
#define SOC_DDRC_DMC_DDRC_CFG_TIMING0_tmrw_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_DDRC_DMC_DDRC_CFG_TIMING2_tmpcwr_START (18)
#define SOC_DDRC_DMC_DDRC_CFG_TIMING2_tmpcwr_END (22)
...
#define SOC_DDRC_DMC_DDRC_CFG_TIMING4_tmrr_START (16)
#define SOC_DDRC_DMC_DDRC_CFG_TIMING4_tmrr_END (19)
#define SOC_DDRC_DMC_DDRC_CFG_TIMING4_tmrd_START (20)
#define SOC_DDRC_DMC_DDRC_CFG_TIMING4_tmrd_END (24)
...
#define SOC_DDRC_DMC_DDRC_CFG_TIMING7_tpbr2pbr_START (16)
#define SOC_DDRC_DMC_DDRC_CFG_TIMING7_tpbr2pbr_END (23)
...
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING0_tmrw_START (28)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING0_tmrw_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING2_tmpcwr_START (18)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING2_tmpcwr_END (22)
...
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING4_tmrr_START (16)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING4_tmrr_END (19)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING4_tmrd_START (20)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING4_tmrd_END (24)
...
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING7_tpbr2pbr_START (16)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING7_tpbr2pbr_END (23)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING7_tckehcmd_START (24)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING7_tckehcmd_END (27)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING7_tescke_START (28)
#define SOC_DDRC_DMC_DDRC_CFG_NXT_TIMING7_tescke_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        unsigned int hiqos_pre_en : 1;
        unsigned int hiqos_rw_en : 1;
        unsigned int reserved : 30;
    } reg;
} SOC_DDRC_DMC_DDRC_CFG_TIMEOUT_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_CFG_TIMEOUT_hiqos_pre_en_START (0)
#define SOC_DDRC_DMC_DDRC_CFG_TIMEOUT_hiqos_pre_en_END (0)
#define SOC_DDRC_DMC_DDRC_CFG_TIMEOUT_hiqos_rw_en_START (1)
#define SOC_DDRC_DMC_DDRC_CFG_TIMEOUT_hiqos_rw_en_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_DDRC_DMC_DDRC_CFG_DDRPHY_soft_bp_en_START (30)
#define SOC_DDRC_DMC_DDRC_CFG_DDRPHY_soft_bp_en_END (30)
#define SOC_DDRC_DMC_DDRC_CFG_DDRPHY_soft_bp_ok_START (31)
#define SOC_DDRC_DMC_DDRC_CFG_DDRPHY_soft_bp_ok_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        unsigned int hiqos_time0 : 8;
        unsigned int hiqos_time1 : 8;
        unsigned int hiqos_time2 : 8;
        unsigned int hiqos_time3 : 8;
    } reg;
} SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME0_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME0_hiqos_time0_START (0)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME0_hiqos_time0_END (7)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME0_hiqos_time1_START (8)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME0_hiqos_time1_END (15)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME0_hiqos_time2_START (16)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME0_hiqos_time2_END (23)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME0_hiqos_time3_START (24)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME0_hiqos_time3_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int hiqos_time4 : 8;
        unsigned int hiqos_time5 : 8;
        unsigned int hiqos_time6 : 8;
        unsigned int hiqos_time7 : 8;
    } reg;
} SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME1_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME1_hiqos_time4_START (0)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME1_hiqos_time4_END (7)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME1_hiqos_time5_START (8)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME1_hiqos_time5_END (15)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME1_hiqos_time6_START (16)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME1_hiqos_time6_END (23)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME1_hiqos_time7_START (24)
#define SOC_DDRC_DMC_DDRC_CFG_HIQOSTIME1_hiqos_time7_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_DDRC_DMC_DDRC_CFG_DUM_EN_ret_cmd_type_START (4)
#define SOC_DDRC_DMC_DDRC_CFG_DUM_EN_ret_cmd_type_END (4)
#define SOC_DDRC_DMC_DDRC_CFG_DUM_EN_ret_mpc_cnt_START (8)
#define SOC_DDRC_DMC_DDRC_CFG_DUM_EN_ret_mpc_cnt_END (10)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_DDRC_DMC_DDRC_CURR_FUNC_in_zq_START (2)
#define SOC_DDRC_DMC_DDRC_CURR_FUNC_in_zq_END (2)
...
#define SOC_DDRC_DMC_DDRC_CURR_FUNC2_in_pd_END (3)
#define SOC_DDRC_DMC_DDRC_CURR_FUNC2_in_tmon_START (4)
#define SOC_DDRC_DMC_DDRC_CURR_FUNC2_in_tmon_END (7)
...
#define SOC_DDRC_DMC_DDRC_HIS_TMON_ERR_tmon_err_rank0_bf_START (16)
#define SOC_DDRC_DMC_DDRC_HIS_TMON_ERR_tmon_err_rank0_bf_END (23)
#define SOC_DDRC_DMC_DDRC_HIS_TMON_ERR_tmon_err_rank1_bf_START (24)
#define SOC_DDRC_DMC_DDRC_HIS_TMON_ERR_tmon_err_rank1_bf_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_DDRC_DMC_DDRC_FUNC_STAT9_arefstate_rnk1_START (4)
#define SOC_DDRC_DMC_DDRC_FUNC_STAT9_arefstate_rnk1_END (7)
...
} SOC_DDRC_DMC_DDRC_CFG_LP_DYN_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_CFG_LP_DYN_dyn_lp_wakeup_en_START (0)
#define SOC_DDRC_DMC_DDRC_CFG_LP_DYN_dyn_lp_wakeup_en_END (0)
#define SOC_DDRC_DMC_DDRC_CFG_LP_DYN_tlp_wakeup_l3_START (8)
#define SOC_DDRC_DMC_DDRC_CFG_LP_DYN_tlp_wakeup_l3_END (11)
#define SOC_DDRC_DMC_DDRC_CFG_LP_DYN_tlp_wakeup_l2_START (16)
#define SOC_DDRC_DMC_DDRC_CFG_LP_DYN_tlp_wakeup_l2_END (19)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_DMC_DDRC_CFG_LP_L2_IDLE_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_CFG_LP_L2_IDLE_lp_l2_idle_START (0)
#define SOC_DDRC_DMC_DDRC_CFG_LP_L2_IDLE_lp_l2_idle_END (19)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_DMC_DDRC_CFG_LP_L3_IDLE_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_CFG_LP_L3_IDLE_lp_l3_idle_START (0)
#define SOC_DDRC_DMC_DDRC_CFG_LP_L3_IDLE_lp_l3_idle_END (19)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        unsigned int pd_cnt : 32;
    } reg;
} SOC_DDRC_DMC_DDRC_HIS_PD_CNT_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_HIS_PD_CNT_pd_cnt_START (0)
#define SOC_DDRC_DMC_DDRC_HIS_PD_CNT_pd_cnt_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int act_pd_cnt : 32;
    } reg;
} SOC_DDRC_DMC_DDRC_HIS_ACT_PD_CNT_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_HIS_ACT_PD_CNT_act_pd_cnt_START (0)
#define SOC_DDRC_DMC_DDRC_HIS_ACT_PD_CNT_act_pd_cnt_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int act_npd_cnt : 32;
    } reg;
} SOC_DDRC_DMC_DDRC_HIS_ACT_NPD_CNT_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_HIS_ACT_NPD_CNT_act_npd_cnt_START (0)
#define SOC_DDRC_DMC_DDRC_HIS_ACT_NPD_CNT_act_npd_cnt_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_DMC_DDRC_INBAND_ECC_CTRL_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_CTRL_inband_ecc_en_START (0)
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_CTRL_inband_ecc_en_END (0)
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_CTRL_inband_ecc_mode_START (1)
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_CTRL_inband_ecc_mode_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_DMC_DDRC_INBAND_ECC_INTMSK_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INTMSK_inband_ecc_err_intmask_START (0)
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INTMSK_inband_ecc_err_intmask_END (0)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_DMC_DDRC_INBAND_ECC_RINT_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_RINT_inband_ecc_err_rint_START (0)
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_RINT_inband_ecc_err_rint_END (0)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_DMC_DDRC_INBAND_ECC_INTSTS_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INTSTS_inband_ecc_err_intsts_START (0)
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INTSTS_inband_ecc_err_intsts_END (0)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_DMC_DDRC_INBAND_ECC_INFO_INDEX_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INFO_INDEX_inband_ecc_info_index_START (0)
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INFO_INDEX_inband_ecc_info_index_END (4)
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INFO_INDEX_inband_ecc_info_clr_START (5)
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INFO_INDEX_inband_ecc_info_clr_END (5)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_DMC_DDRC_INBAND_ECC_INFO_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INFO_inband_ecc_info_START (0)
#define SOC_DDRC_DMC_DDRC_INBAND_ECC_INFO_inband_ecc_info_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        ...
        unsigned int st_clk_ddrphy_bypass : 1;
        unsigned int st_clk_ddrphy_ref : 1;
        unsigned int st_clk_h2h_s : 1;
        unsigned int st_clk_p2p_s : 1;
        unsigned int gt_clk_uce_subsys : 1;
        unsigned int swdone_clk_uce_subsys : 1;
        unsigned int st_clk_dfi_phy : 1;
        unsigned int gt_clk_ddrphy_ref_bypass_wodft : 1;
        unsigned int gt_auto_clk_ddrphy : 1;
        unsigned int reserved : 14;
    } reg;
} SOC_DDRC_DMC_DDRC_COMMON_RDATA0_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_p2p_m_START (0)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_p2p_m_END (0)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_dmc_apb_START (1)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_dmc_apb_END (1)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_pack_apb_START (2)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_pack_apb_END (2)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_uce_START (3)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_uce_END (3)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_uce_bus_START (4)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_uce_bus_END (4)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_dfi_pack_START (5)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_dfi_pack_END (5)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_dfi_dmc_START (6)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_dfi_dmc_END (6)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_dmc_free_START (7)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_dmc_free_END (7)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_uce_engine_START (8)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_uce_engine_END (8)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_ddrphy_bypass_START (9)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_ddrphy_bypass_END (9)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_ddrphy_ref_START (10)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_ddrphy_ref_END (10)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_h2h_s_START (11)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_h2h_s_END (11)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_p2p_s_START (12)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_p2p_s_END (12)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_gt_clk_uce_subsys_START (13)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_gt_clk_uce_subsys_END (13)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_swdone_clk_uce_subsys_START (14)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_swdone_clk_uce_subsys_END (14)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_dfi_phy_START (15)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_st_clk_dfi_phy_END (15)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_gt_clk_ddrphy_ref_bypass_wodft_START (16)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_gt_clk_ddrphy_ref_bypass_wodft_END (16)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_gt_auto_clk_ddrphy_START (17)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA0_gt_auto_clk_ddrphy_END (17)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_DMC_DDRC_COMMON_RDATA1_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA1_uce_m3_idle_START (0)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA1_uce_m3_idle_END (0)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA1_uce_sys_idle_START (1)
#define SOC_DDRC_DMC_DDRC_COMMON_RDATA1_uce_sys_idle_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_DMC_DDRC_COMMON_CTRL5_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL5_tz_dmc_secure_n_START (0)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL5_tz_dmc_secure_n_END (0)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL5_tz_uce_secure_n_START (1)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL5_tz_uce_secure_n_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        ...
        unsigned int clk_ref_auto_bypass_ext : 1;
...
} SOC_DDRC_DMC_DDRC_COMMON_CTRL4_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_clk_dmc_free_auto_bypass_START (0)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_clk_dmc_free_auto_bypass_END (0)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_clk_dmc_free_auto_bypass_ext_START (1)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_clk_dmc_free_auto_bypass_ext_END (1)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_reset_pack_dfi_n_START (2)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_reset_pack_dfi_n_END (2)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_clk_ref_auto_bypass_ext_START (3)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_clk_ref_auto_bypass_ext_END (3)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_clk_bypass_auto_bypass_ext_START (4)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_clk_bypass_auto_bypass_ext_END (4)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_cnt_wait_wake_cfg_START (5)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_cnt_wait_wake_cfg_END (8)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_reset_uce_h2hbrg_m_START (11)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_reset_uce_h2hbrg_m_END (11)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_clk_wr_en_START (16)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL4_clk_wr_en_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        ...
        unsigned int bypass_p2p : 1;
        unsigned int bypass_wrbuf : 1;
        unsigned int uc_h2h_m_gt_en : 1;
        unsigned int reserved_2 : 1;
        unsigned int clk_wr_en : 16;
    } reg;
} SOC_DDRC_DMC_DDRC_COMMON_CTRL0_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL0_phyupd_reqen_byp_START (0)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL0_phyupd_reqen_byp_END (0)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL0_dmc_apb_gt_en_START (6)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL0_dmc_apb_gt_en_END (6)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL0_bypass_p2p_START (12)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL0_bypass_p2p_END (12)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL0_bypass_wrbuf_START (13)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL0_bypass_wrbuf_END (13)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL0_uc_h2h_m_gt_en_START (14)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL0_uc_h2h_m_gt_en_END (14)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL0_clk_wr_en_START (16)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL0_clk_wr_en_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_DMC_DDRC_COMMON_CTRL1_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_clk_ddrphy_apb_ac_START (0)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_clk_ddrphy_apb_ac_END (0)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dfi_clk_ddrphy_START (1)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dfi_clk_ddrphy_END (1)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dfi_clk_dlyline_START (2)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_dfi_clk_dlyline_END (2)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_rs_neg_rx_clock_START (3)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_rs_neg_rx_clock_END (3)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_rs1_rx_clock_START (4)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_rs1_rx_clock_END (4)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_rs2_rx_clock_START (5)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_rs2_rx_clock_END (5)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_rs0_tx_clock_START (6)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_rs0_tx_clock_END (6)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_rs1_tx_clock_START (7)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_rs1_tx_clock_END (7)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_rs_neg_tx_clock_START (8)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_rs_neg_tx_clock_END (8)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_clk_wr_en_START (16)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL1_clk_wr_en_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_DDRC_DMC_DDRC_COMMON_CTRL2_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_pack_apb_START (0)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_pack_apb_END (0)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_START (1)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_END (1)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_bus_START (2)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_bus_END (2)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_dfi_pack_START (3)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_dfi_pack_END (3)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_dfi_dmc_START (4)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_dfi_dmc_END (4)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_dmc_free_START (5)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_dmc_free_END (5)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_engine_START (6)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_engine_END (6)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_ddrphy_bypass_START (7)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_ddrphy_bypass_END (7)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_ddrphy_ref_START (8)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_ddrphy_ref_END (8)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_ddr_autoselfrefresh_ind_bypass_START (9)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_ddr_autoselfrefresh_ind_bypass_END (9)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_pack_apb_auto_bypass_ext_START (10)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_pack_apb_auto_bypass_ext_END (10)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_auto_bypass_ext_START (11)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_auto_bypass_ext_END (11)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_bus_auto_bypass_ext_START (12)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_bus_auto_bypass_ext_END (12)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_dfi_pack_auto_bypass_ext_START (13)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_dfi_pack_auto_bypass_ext_END (13)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_auto_bypass_START (14)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_auto_bypass_END (14)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_bus_auto_bypass_START (15)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_uce_bus_auto_bypass_END (15)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_wr_en_START (16)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL2_clk_wr_en_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        ...
        unsigned int clk_dmc_apb : 1;
        unsigned int clk_h2h_s : 1;
        unsigned int reset_dmc_n : 1;
        unsigned int clk_pack_apb_auto_bypass : 1;
        unsigned int clk_wr_en : 16;
    } reg;
} SOC_DDRC_DMC_DDRC_COMMON_CTRL3_UNION;
#endif
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_dfi_pack_auto_bypass_START (0)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_dfi_pack_auto_bypass_END (0)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_ddrphy_bypassref_auto_bypass_START (1)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_ddrphy_bypassref_auto_bypass_END (1)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_ddrphy_bypass_ref_ind_auto_bypass_START (2)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_ddrphy_bypass_ref_ind_auto_bypass_END (2)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_ddrphy_bypassref_enable_START (3)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_ddrphy_bypassref_enable_END (3)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_ref_div_START (4)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_ref_div_END (4)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_uc_div_START (5)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_uc_div_END (6)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_reset_uce_n_START (7)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_reset_uce_n_END (7)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_reset_ucem3_n_START (8)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_reset_ucem3_n_END (8)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_reset_pack_n_START (9)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_reset_pack_n_END (9)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_reset_dmc_free_n_START (10)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_reset_dmc_free_n_END (10)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_reset_uce_engine_n_START (11)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_reset_uce_engine_n_END (11)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_dmc_apb_START (12)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_dmc_apb_END (12)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_h2h_s_START (13)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_h2h_s_END (13)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_reset_dmc_n_START (14)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_reset_dmc_n_END (14)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_pack_apb_auto_bypass_START (15)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_pack_apb_auto_bypass_END (15)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_wr_en_START (16)
#define SOC_DDRC_DMC_DDRC_COMMON_CTRL3_clk_wr_en_END (31)
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
