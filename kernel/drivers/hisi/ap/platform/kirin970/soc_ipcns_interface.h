...
#define SOC_IPCNS_MBX_SOURCE_source_END (8)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IPCNS_MBX_DSET_dset_END (8)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IPCNS_MBX_DCLEAR_dclear_END (8)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IPCNS_MBX_DSTATUS_dstatus_END (8)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IPCNS_MBX_IMASK_int_mask_END (8)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IPCNS_MBX_ICLR_int_clear_END (8)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_IPCNS_MBX_SEND_send_END (8)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
