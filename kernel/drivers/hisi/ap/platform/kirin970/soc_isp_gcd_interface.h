...
#define SOC_ISP_GCD_LSC_LUT_ADDR(base,Range256) ((base) + (0x0100+0x4*(Range256)))
#define SOC_ISP_GCD_DYN_TH_SCALE_ADDR(base) ((base) + (0x0500))
#define SOC_ISP_GCD_DYN_TH_MAX_ADDR(base) ((base) + (0x0504))
#define SOC_ISP_GCD_VAR_TH_ADDR(base) ((base) + (0x0508))
#define SOC_ISP_GCD_IPNR_THD_COEF_ADDR(base,Range17) ((base) + (0x050C+0x4*(Range17)))
#define SOC_ISP_GCD_VAR_THD_COEF_ADDR(base,Range17) ((base) + (0x0550+0x4*(Range17)))
...
#define SOC_ISP_GCD_GCD_CONFIG_active_bypass_START (1)
#define SOC_ISP_GCD_GCD_CONFIG_active_bypass_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_ISP_GCD_LSC_LUT_UNION;
#endif
#define SOC_ISP_GCD_LSC_LUT_lcsgain_START (0)
#define SOC_ISP_GCD_LSC_LUT_lcsgain_END (10)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int dyndarkthscale : 8;
        unsigned int hotipnren : 1;
        unsigned int reserved_0 : 7;
        unsigned int dynhotthscale : 8;
        unsigned int darkipnren : 1;
        unsigned int reserved_1 : 7;
    } reg;
} SOC_ISP_GCD_DYN_TH_SCALE_UNION;
#endif
#define SOC_ISP_GCD_DYN_TH_SCALE_dyndarkthscale_START (0)
#define SOC_ISP_GCD_DYN_TH_SCALE_dyndarkthscale_END (7)
#define SOC_ISP_GCD_DYN_TH_SCALE_hotipnren_START (8)
#define SOC_ISP_GCD_DYN_TH_SCALE_hotipnren_END (8)
#define SOC_ISP_GCD_DYN_TH_SCALE_dynhotthscale_START (16)
#define SOC_ISP_GCD_DYN_TH_SCALE_dynhotthscale_END (23)
#define SOC_ISP_GCD_DYN_TH_SCALE_darkipnren_START (24)
#define SOC_ISP_GCD_DYN_TH_SCALE_darkipnren_END (24)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int dyndarkthmax : 14;
        unsigned int reserved_0 : 2;
        unsigned int dynhotthmax : 14;
        unsigned int reserved_1 : 2;
    } reg;
} SOC_ISP_GCD_DYN_TH_MAX_UNION;
#endif
#define SOC_ISP_GCD_DYN_TH_MAX_dyndarkthmax_START (0)
#define SOC_ISP_GCD_DYN_TH_MAX_dyndarkthmax_END (13)
#define SOC_ISP_GCD_DYN_TH_MAX_dynhotthmax_START (16)
#define SOC_ISP_GCD_DYN_TH_MAX_dynhotthmax_END (29)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int varth_offset_thld : 8;
        unsigned int varth_offset_slope : 8;
        unsigned int max_varth_offset : 8;
        unsigned int highlight_err_ctl_en1 : 1;
        unsigned int highlight_err_ctl_en2 : 1;
        unsigned int reserved : 6;
    } reg;
} SOC_ISP_GCD_VAR_TH_UNION;
#endif
#define SOC_ISP_GCD_VAR_TH_varth_offset_thld_START (0)
#define SOC_ISP_GCD_VAR_TH_varth_offset_thld_END (7)
#define SOC_ISP_GCD_VAR_TH_varth_offset_slope_START (8)
#define SOC_ISP_GCD_VAR_TH_varth_offset_slope_END (15)
#define SOC_ISP_GCD_VAR_TH_max_varth_offset_START (16)
#define SOC_ISP_GCD_VAR_TH_max_varth_offset_END (23)
#define SOC_ISP_GCD_VAR_TH_highlight_err_ctl_en1_START (24)
#define SOC_ISP_GCD_VAR_TH_highlight_err_ctl_en1_END (24)
#define SOC_ISP_GCD_VAR_TH_highlight_err_ctl_en2_START (25)
#define SOC_ISP_GCD_VAR_TH_highlight_err_ctl_en2_END (25)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int ipnr_thd_dark_coef : 14;
        unsigned int reserved_0 : 2;
        unsigned int ipnr_thd_hot_coef : 14;
        unsigned int reserved_1 : 2;
    } reg;
} SOC_ISP_GCD_IPNR_THD_COEF_UNION;
#endif
#define SOC_ISP_GCD_IPNR_THD_COEF_ipnr_thd_dark_coef_START (0)
#define SOC_ISP_GCD_IPNR_THD_COEF_ipnr_thd_dark_coef_END (13)
#define SOC_ISP_GCD_IPNR_THD_COEF_ipnr_thd_hot_coef_START (16)
#define SOC_ISP_GCD_IPNR_THD_COEF_ipnr_thd_hot_coef_END (29)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int var_thd_coef : 8;
        unsigned int reserved : 24;
    } reg;
} SOC_ISP_GCD_VAR_THD_COEF_UNION;
#endif
#define SOC_ISP_GCD_VAR_THD_COEF_var_thd_coef_START (0)
#define SOC_ISP_GCD_VAR_THD_COEF_var_thd_coef_END (7)
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
