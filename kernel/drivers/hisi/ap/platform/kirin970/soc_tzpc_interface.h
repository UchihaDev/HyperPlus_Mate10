...
#define SOC_TZPC_AO_REG0_STAT_ADDR(base) ((base) + (0x86C))
#define SOC_TZPC_AO_REG1_STAT_ADDR(base) ((base) + (0x870))
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int peri_loadmonitor : 1;
        unsigned int CTF : 1;
...
#define SOC_TZPC_DECPROT2STAT_peri_loadmonitor_START (4)
#define SOC_TZPC_DECPROT2STAT_peri_loadmonitor_END (4)
#define SOC_TZPC_DECPROT2STAT_CTF_START (5)
#define SOC_TZPC_DECPROT2STAT_CTF_END (5)
...
#define SOC_TZPC_DECPROT2SET_peri_loadmonitor_START (4)
#define SOC_TZPC_DECPROT2SET_peri_loadmonitor_END (4)
#define SOC_TZPC_DECPROT2SET_CTF_START (5)
#define SOC_TZPC_DECPROT2SET_CTF_END (5)
...
#define SOC_TZPC_DECPROT2CLR_peri_loadmonitor_START (4)
#define SOC_TZPC_DECPROT2CLR_peri_loadmonitor_END (4)
#define SOC_TZPC_DECPROT2CLR_CTF_START (5)
#define SOC_TZPC_DECPROT2CLR_CTF_END (5)
...
typedef union
{
    ...
    struct
    {
        unsigned int pcie1_firewall : 8;
        unsigned int pcie0_firewall : 8;
        unsigned int reserved_0 : 8;
        unsigned int gpio0_emmc : 1;
        unsigned int gpio1_emmc : 1;
        unsigned int reserved_1 : 1;
        unsigned int reserved_2 : 1;
        unsigned int sd30 : 1;
...
#endif
#define SOC_TZPC_DECPROT3STAT_pcie1_firewall_START (0)
#define SOC_TZPC_DECPROT3STAT_pcie1_firewall_END (7)
#define SOC_TZPC_DECPROT3STAT_pcie0_firewall_START (8)
#define SOC_TZPC_DECPROT3STAT_pcie0_firewall_END (15)
#define SOC_TZPC_DECPROT3STAT_gpio0_emmc_START (24)
#define SOC_TZPC_DECPROT3STAT_gpio0_emmc_END (24)
#define SOC_TZPC_DECPROT3STAT_gpio1_emmc_START (25)
#define SOC_TZPC_DECPROT3STAT_gpio1_emmc_END (25)
...
#define SOC_TZPC_DECPROT3STAT_mmc0_sys_ctrl_START (30)
#define SOC_TZPC_DECPROT3STAT_mmc0_sys_ctrl_END (30)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_TZPC_DECPROT3SET_pcie1_firewall_START (0)
#define SOC_TZPC_DECPROT3SET_pcie1_firewall_END (7)
#define SOC_TZPC_DECPROT3SET_pcie0_firewall_START (8)
#define SOC_TZPC_DECPROT3SET_pcie0_firewall_END (15)
#define SOC_TZPC_DECPROT3SET_gpio0_emmc_START (24)
#define SOC_TZPC_DECPROT3SET_gpio0_emmc_END (24)
#define SOC_TZPC_DECPROT3SET_gpio1_emmc_START (25)
#define SOC_TZPC_DECPROT3SET_gpio1_emmc_END (25)
...
#define SOC_TZPC_DECPROT3SET_mmc0_sys_ctrl_START (30)
#define SOC_TZPC_DECPROT3SET_mmc0_sys_ctrl_END (30)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_TZPC_DECPROT3CLR_pcie1_firewall_START (0)
#define SOC_TZPC_DECPROT3CLR_pcie1_firewall_END (7)
#define SOC_TZPC_DECPROT3CLR_pcie0_firewall_START (8)
#define SOC_TZPC_DECPROT3CLR_pcie0_firewall_END (15)
#define SOC_TZPC_DECPROT3CLR_gpio0_emmc_START (24)
#define SOC_TZPC_DECPROT3CLR_gpio0_emmc_END (24)
#define SOC_TZPC_DECPROT3CLR_gpio1_emmc_START (25)
#define SOC_TZPC_DECPROT3CLR_gpio1_emmc_END (25)
...
#define SOC_TZPC_DECPROT3CLR_mmc0_sys_ctrl_START (30)
#define SOC_TZPC_DECPROT3CLR_mmc0_sys_ctrl_END (30)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        ...
        unsigned int ipc : 1;
        unsigned int ioc_region1 : 1;
        unsigned int ioc_region2 : 1;
        ...
        unsigned int i2c7 : 1;
        unsigned int reserved_5 : 1;
        unsigned int ufs_sctrl : 1;
        unsigned int ufs : 1;
        unsigned int mmc0_ioc : 1;
        unsigned int mmc1_ioc : 1;
    } reg;
...
#define SOC_TZPC_DECPROT4STAT_ioc_region1_START (7)
#define SOC_TZPC_DECPROT4STAT_ioc_region1_END (7)
#define SOC_TZPC_DECPROT4STAT_ioc_region2_START (8)
#define SOC_TZPC_DECPROT4STAT_ioc_region2_END (8)
#define SOC_TZPC_DECPROT4STAT_vcodecbus_START (9)
#define SOC_TZPC_DECPROT4STAT_vcodecbus_END (9)
...
#define SOC_TZPC_DECPROT4STAT_ufs_sctrl_START (28)
#define SOC_TZPC_DECPROT4STAT_ufs_sctrl_END (28)
#define SOC_TZPC_DECPROT4STAT_ufs_START (29)
#define SOC_TZPC_DECPROT4STAT_ufs_END (29)
#define SOC_TZPC_DECPROT4STAT_mmc0_ioc_START (30)
#define SOC_TZPC_DECPROT4STAT_mmc0_ioc_END (30)
#define SOC_TZPC_DECPROT4STAT_mmc1_ioc_START (31)
#define SOC_TZPC_DECPROT4STAT_mmc1_ioc_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_TZPC_DECPROT4SET_ioc_region1_START (7)
#define SOC_TZPC_DECPROT4SET_ioc_region1_END (7)
#define SOC_TZPC_DECPROT4SET_ioc_region2_START (8)
#define SOC_TZPC_DECPROT4SET_ioc_region2_END (8)
#define SOC_TZPC_DECPROT4SET_vcodecbus_START (9)
#define SOC_TZPC_DECPROT4SET_vcodecbus_END (9)
...
#define SOC_TZPC_DECPROT4SET_ufs_sctrl_START (28)
#define SOC_TZPC_DECPROT4SET_ufs_sctrl_END (28)
#define SOC_TZPC_DECPROT4SET_ufs_START (29)
#define SOC_TZPC_DECPROT4SET_ufs_END (29)
#define SOC_TZPC_DECPROT4SET_mmc0_ioc_START (30)
#define SOC_TZPC_DECPROT4SET_mmc0_ioc_END (30)
#define SOC_TZPC_DECPROT4SET_mmc1_ioc_START (31)
#define SOC_TZPC_DECPROT4SET_mmc1_ioc_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_TZPC_DECPROT4CLR_ioc_region1_START (7)
#define SOC_TZPC_DECPROT4CLR_ioc_region1_END (7)
#define SOC_TZPC_DECPROT4CLR_ioc_region2_START (8)
#define SOC_TZPC_DECPROT4CLR_ioc_region2_END (8)
#define SOC_TZPC_DECPROT4CLR_vcodecbus_START (9)
#define SOC_TZPC_DECPROT4CLR_vcodecbus_END (9)
...
#define SOC_TZPC_DECPROT4CLR_ufs_sctrl_START (28)
#define SOC_TZPC_DECPROT4CLR_ufs_sctrl_END (28)
#define SOC_TZPC_DECPROT4CLR_ufs_START (29)
#define SOC_TZPC_DECPROT4CLR_ufs_END (29)
#define SOC_TZPC_DECPROT4CLR_mmc0_ioc_START (30)
#define SOC_TZPC_DECPROT4CLR_mmc0_ioc_END (30)
#define SOC_TZPC_DECPROT4CLR_mmc1_ioc_START (31)
#define SOC_TZPC_DECPROT4CLR_mmc1_ioc_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        ...
        unsigned int reserved_1 : 1;
        unsigned int LPM3_PMUSSI0_RTC : 1;
        unsigned int reserved_2 : 1;
        unsigned int reserved_3 : 1;
        unsigned int reserved_4 : 1;
        unsigned int reserved_5 : 1;
...
#endif
#define SOC_TZPC_DECPROT5STAT_lpm3_pmui2c1_START (0)
#define SOC_TZPC_DECPROT5STAT_lpm3_pmui2c1_END (0)
...
#define SOC_TZPC_DECPROT5STAT_lpm3_pmui2c0_START (5)
#define SOC_TZPC_DECPROT5STAT_lpm3_pmui2c0_END (5)
...
#define SOC_TZPC_DECPROT5STAT_LPM3_PMUSSI0_RTC_START (19)
#define SOC_TZPC_DECPROT5STAT_LPM3_PMUSSI0_RTC_END (19)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_TZPC_DECPROT5SET_lpm3_pmui2c1_START (0)
#define SOC_TZPC_DECPROT5SET_lpm3_pmui2c1_END (0)
...
#define SOC_TZPC_DECPROT5SET_lpm3_pmui2c0_START (5)
#define SOC_TZPC_DECPROT5SET_lpm3_pmui2c0_END (5)
...
#define SOC_TZPC_DECPROT5SET_LPM3_PMUSSI0_RTC_START (19)
#define SOC_TZPC_DECPROT5SET_LPM3_PMUSSI0_RTC_END (19)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_TZPC_DECPROT5CLR_lpm3_pmui2c1_START (0)
#define SOC_TZPC_DECPROT5CLR_lpm3_pmui2c1_END (0)
...
#define SOC_TZPC_DECPROT5CLR_lpm3_pmui2c0_START (5)
#define SOC_TZPC_DECPROT5CLR_lpm3_pmui2c0_END (5)
...
#define SOC_TZPC_DECPROT5CLR_LPM3_PMUSSI0_RTC_START (19)
#define SOC_TZPC_DECPROT5CLR_LPM3_PMUSSI0_RTC_END (19)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_TZPC_DECPROT6STAT_pi_monitor_START (17)
#define SOC_TZPC_DECPROT6STAT_pi_monitor_END (17)
...
#define SOC_TZPC_DECPROT6STAT_ufs_START (21)
#define SOC_TZPC_DECPROT6STAT_ufs_END (21)
...
#define SOC_TZPC_DECPROT6SET_pi_monitor_START (17)
#define SOC_TZPC_DECPROT6SET_pi_monitor_END (17)
...
#define SOC_TZPC_DECPROT6SET_ufs_START (21)
#define SOC_TZPC_DECPROT6SET_ufs_END (21)
...
#define SOC_TZPC_DECPROT6CLR_pi_monitor_START (17)
#define SOC_TZPC_DECPROT6CLR_pi_monitor_END (17)
...
#define SOC_TZPC_DECPROT6CLR_ufs_START (21)
#define SOC_TZPC_DECPROT6CLR_ufs_END (21)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int reserved_7 : 1;
        unsigned int reserved_8 : 1;
        unsigned int media_crg_region0 : 1;
        unsigned int media_crg_region1 : 1;
        unsigned int media_crg_region2 : 1;
        unsigned int media_crg_region3 : 1;
        unsigned int reserved_9 : 1;
        unsigned int reserved_10 : 1;
        unsigned int reserved_11 : 1;
        unsigned int reserved_12 : 1;
...
#define SOC_TZPC_DECPROT7STAT_pi_monitor_START (8)
#define SOC_TZPC_DECPROT7STAT_pi_monitor_END (8)
#define SOC_TZPC_DECPROT7STAT_bisr_START (9)
#define SOC_TZPC_DECPROT7STAT_bisr_END (9)
#define SOC_TZPC_DECPROT7STAT_cnn_START (12)
#define SOC_TZPC_DECPROT7STAT_cnn_END (12)
#define SOC_TZPC_DECPROT7STAT_media_crg_region0_START (16)
#define SOC_TZPC_DECPROT7STAT_media_crg_region0_END (16)
#define SOC_TZPC_DECPROT7STAT_media_crg_region1_START (17)
#define SOC_TZPC_DECPROT7STAT_media_crg_region1_END (17)
#define SOC_TZPC_DECPROT7STAT_media_crg_region2_START (18)
#define SOC_TZPC_DECPROT7STAT_media_crg_region2_END (18)
#define SOC_TZPC_DECPROT7STAT_media_crg_region3_START (19)
#define SOC_TZPC_DECPROT7STAT_media_crg_region3_END (19)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_TZPC_DECPROT7SET_pi_monitor_START (8)
#define SOC_TZPC_DECPROT7SET_pi_monitor_END (8)
#define SOC_TZPC_DECPROT7SET_bisr_START (9)
#define SOC_TZPC_DECPROT7SET_bisr_END (9)
#define SOC_TZPC_DECPROT7SET_cnn_START (12)
#define SOC_TZPC_DECPROT7SET_cnn_END (12)
#define SOC_TZPC_DECPROT7SET_media_crg_region0_START (16)
#define SOC_TZPC_DECPROT7SET_media_crg_region0_END (16)
#define SOC_TZPC_DECPROT7SET_media_crg_region1_START (17)
#define SOC_TZPC_DECPROT7SET_media_crg_region1_END (17)
#define SOC_TZPC_DECPROT7SET_media_crg_region2_START (18)
#define SOC_TZPC_DECPROT7SET_media_crg_region2_END (18)
#define SOC_TZPC_DECPROT7SET_media_crg_region3_START (19)
#define SOC_TZPC_DECPROT7SET_media_crg_region3_END (19)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_TZPC_DECPROT7CLR_pi_monitor_START (8)
#define SOC_TZPC_DECPROT7CLR_pi_monitor_END (8)
#define SOC_TZPC_DECPROT7CLR_bisr_START (9)
#define SOC_TZPC_DECPROT7CLR_bisr_END (9)
#define SOC_TZPC_DECPROT7CLR_cnn_START (12)
#define SOC_TZPC_DECPROT7CLR_cnn_END (12)
#define SOC_TZPC_DECPROT7CLR_media_crg_region0_START (16)
#define SOC_TZPC_DECPROT7CLR_media_crg_region0_END (16)
#define SOC_TZPC_DECPROT7CLR_media_crg_region1_START (17)
#define SOC_TZPC_DECPROT7CLR_media_crg_region1_END (17)
#define SOC_TZPC_DECPROT7CLR_media_crg_region2_START (18)
#define SOC_TZPC_DECPROT7CLR_media_crg_region2_END (18)
#define SOC_TZPC_DECPROT7CLR_media_crg_region3_START (19)
#define SOC_TZPC_DECPROT7CLR_media_crg_region3_END (19)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int ao_ioc_region1 : 1;
        unsigned int ao_ioc_region2 : 1;
...
#define SOC_TZPC_AO_DECPROT0STAT_sctrl_region1_START (6)
#define SOC_TZPC_AO_DECPROT0STAT_sctrl_region1_END (6)
#define SOC_TZPC_AO_DECPROT0STAT_sctrl_region2_START (7)
#define SOC_TZPC_AO_DECPROT0STAT_sctrl_region2_END (7)
#define SOC_TZPC_AO_DECPROT0STAT_sctrl_region3_START (8)
#define SOC_TZPC_AO_DECPROT0STAT_sctrl_region3_END (8)
#define SOC_TZPC_AO_DECPROT0STAT_sctrl_region4_START (9)
#define SOC_TZPC_AO_DECPROT0STAT_sctrl_region4_END (9)
#define SOC_TZPC_AO_DECPROT0STAT_sctrl_region5_START (10)
#define SOC_TZPC_AO_DECPROT0STAT_sctrl_region5_END (10)
#define SOC_TZPC_AO_DECPROT0STAT_sctrl_region6_START (11)
#define SOC_TZPC_AO_DECPROT0STAT_sctrl_region6_END (11)
...
#define SOC_TZPC_AO_DECPROT0STAT_ao_ioc_region1_START (18)
#define SOC_TZPC_AO_DECPROT0STAT_ao_ioc_region1_END (18)
#define SOC_TZPC_AO_DECPROT0STAT_ao_ioc_region2_START (19)
#define SOC_TZPC_AO_DECPROT0STAT_ao_ioc_region2_END (19)
...
#define SOC_TZPC_AO_DECPROT0STAT_mmbuf_START (30)
#define SOC_TZPC_AO_DECPROT0STAT_mmbuf_END (30)
#define SOC_TZPC_AO_DECPROT0STAT_asc_START (31)
#define SOC_TZPC_AO_DECPROT0STAT_asc_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_TZPC_AO_DECPROT0SET_sctrl_region1_START (6)
#define SOC_TZPC_AO_DECPROT0SET_sctrl_region1_END (6)
#define SOC_TZPC_AO_DECPROT0SET_sctrl_region2_START (7)
#define SOC_TZPC_AO_DECPROT0SET_sctrl_region2_END (7)
#define SOC_TZPC_AO_DECPROT0SET_sctrl_region3_START (8)
#define SOC_TZPC_AO_DECPROT0SET_sctrl_region3_END (8)
#define SOC_TZPC_AO_DECPROT0SET_sctrl_region4_START (9)
#define SOC_TZPC_AO_DECPROT0SET_sctrl_region4_END (9)
#define SOC_TZPC_AO_DECPROT0SET_sctrl_region5_START (10)
#define SOC_TZPC_AO_DECPROT0SET_sctrl_region5_END (10)
#define SOC_TZPC_AO_DECPROT0SET_sctrl_region6_START (11)
#define SOC_TZPC_AO_DECPROT0SET_sctrl_region6_END (11)
...
#define SOC_TZPC_AO_DECPROT0SET_ao_ioc_region1_START (18)
#define SOC_TZPC_AO_DECPROT0SET_ao_ioc_region1_END (18)
#define SOC_TZPC_AO_DECPROT0SET_ao_ioc_region2_START (19)
#define SOC_TZPC_AO_DECPROT0SET_ao_ioc_region2_END (19)
...
#define SOC_TZPC_AO_DECPROT0SET_mmbuf_START (30)
#define SOC_TZPC_AO_DECPROT0SET_mmbuf_END (30)
#define SOC_TZPC_AO_DECPROT0SET_asc_START (31)
#define SOC_TZPC_AO_DECPROT0SET_asc_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_TZPC_AO_DECPROT0CLR_sctrl_region1_START (6)
#define SOC_TZPC_AO_DECPROT0CLR_sctrl_region1_END (6)
#define SOC_TZPC_AO_DECPROT0CLR_sctrl_region2_START (7)
#define SOC_TZPC_AO_DECPROT0CLR_sctrl_region2_END (7)
#define SOC_TZPC_AO_DECPROT0CLR_sctrl_region3_START (8)
#define SOC_TZPC_AO_DECPROT0CLR_sctrl_region3_END (8)
#define SOC_TZPC_AO_DECPROT0CLR_sctrl_region4_START (9)
#define SOC_TZPC_AO_DECPROT0CLR_sctrl_region4_END (9)
#define SOC_TZPC_AO_DECPROT0CLR_sctrl_region5_START (10)
#define SOC_TZPC_AO_DECPROT0CLR_sctrl_region5_END (10)
#define SOC_TZPC_AO_DECPROT0CLR_sctrl_region6_START (11)
#define SOC_TZPC_AO_DECPROT0CLR_sctrl_region6_END (11)
...
#define SOC_TZPC_AO_DECPROT0CLR_ao_ioc_region1_START (18)
#define SOC_TZPC_AO_DECPROT0CLR_ao_ioc_region1_END (18)
#define SOC_TZPC_AO_DECPROT0CLR_ao_ioc_region2_START (19)
#define SOC_TZPC_AO_DECPROT0CLR_ao_ioc_region2_END (19)
...
#define SOC_TZPC_AO_DECPROT0CLR_mmbuf_START (30)
#define SOC_TZPC_AO_DECPROT0CLR_mmbuf_END (30)
#define SOC_TZPC_AO_DECPROT0CLR_asc_START (31)
#define SOC_TZPC_AO_DECPROT0CLR_asc_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_TZPC_AO_DECPROT1STAT_ao_ipc_ns_START (3)
#define SOC_TZPC_AO_DECPROT1STAT_ao_ipc_ns_END (3)
#define SOC_TZPC_AO_DECPROT1STAT_ao_ipc_s_START (4)
#define SOC_TZPC_AO_DECPROT1STAT_ao_ipc_s_END (4)
#define SOC_TZPC_AO_DECPROT1STAT_ao_loadmonitor_START (5)
#define SOC_TZPC_AO_DECPROT1STAT_ao_loadmonitor_END (5)
#define SOC_TZPC_AO_DECPROT1STAT_gpio18_START (6)
#define SOC_TZPC_AO_DECPROT1STAT_gpio18_END (6)
#define SOC_TZPC_AO_DECPROT1STAT_gpio19_START (7)
#define SOC_TZPC_AO_DECPROT1STAT_gpio19_END (7)
#define SOC_TZPC_AO_DECPROT1STAT_spi3_START (8)
#define SOC_TZPC_AO_DECPROT1STAT_spi3_END (8)
#define SOC_TZPC_AO_DECPROT1STAT_ddr_test_cfg_START (9)
#define SOC_TZPC_AO_DECPROT1STAT_ddr_test_cfg_END (9)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_TZPC_AO_DECPROT1SET_ao_ipc_ns_START (3)
#define SOC_TZPC_AO_DECPROT1SET_ao_ipc_ns_END (3)
#define SOC_TZPC_AO_DECPROT1SET_ao_ipc_s_START (4)
#define SOC_TZPC_AO_DECPROT1SET_ao_ipc_s_END (4)
#define SOC_TZPC_AO_DECPROT1SET_ao_loadmonitor_START (5)
#define SOC_TZPC_AO_DECPROT1SET_ao_loadmonitor_END (5)
#define SOC_TZPC_AO_DECPROT1SET_gpio18_START (6)
#define SOC_TZPC_AO_DECPROT1SET_gpio18_END (6)
#define SOC_TZPC_AO_DECPROT1SET_gpio19_START (7)
#define SOC_TZPC_AO_DECPROT1SET_gpio19_END (7)
#define SOC_TZPC_AO_DECPROT1SET_spi3_START (8)
#define SOC_TZPC_AO_DECPROT1SET_spi3_END (8)
#define SOC_TZPC_AO_DECPROT1SET_ddr_test_cfg_START (9)
#define SOC_TZPC_AO_DECPROT1SET_ddr_test_cfg_END (9)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_TZPC_AO_DECPROT1CLR_ao_ipc_ns_START (3)
#define SOC_TZPC_AO_DECPROT1CLR_ao_ipc_ns_END (3)
#define SOC_TZPC_AO_DECPROT1CLR_ao_ipc_s_START (4)
#define SOC_TZPC_AO_DECPROT1CLR_ao_ipc_s_END (4)
#define SOC_TZPC_AO_DECPROT1CLR_ao_loadmonitor_START (5)
#define SOC_TZPC_AO_DECPROT1CLR_ao_loadmonitor_END (5)
#define SOC_TZPC_AO_DECPROT1CLR_gpio18_START (6)
#define SOC_TZPC_AO_DECPROT1CLR_gpio18_END (6)
#define SOC_TZPC_AO_DECPROT1CLR_gpio19_START (7)
#define SOC_TZPC_AO_DECPROT1CLR_gpio19_END (7)
#define SOC_TZPC_AO_DECPROT1CLR_spi3_START (8)
#define SOC_TZPC_AO_DECPROT1CLR_spi3_END (8)
#define SOC_TZPC_AO_DECPROT1CLR_ddr_test_cfg_START (9)
#define SOC_TZPC_AO_DECPROT1CLR_ddr_test_cfg_END (9)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int mmbuf_firewall : 16;
        unsigned int reserved_0 : 15;
        unsigned int reserved_1 : 1;
    } reg;
} SOC_TZPC_AO_DECPROT2STAT_UNION;
#endif
#define SOC_TZPC_AO_DECPROT2STAT_mmbuf_firewall_START (0)
#define SOC_TZPC_AO_DECPROT2STAT_mmbuf_firewall_END (15)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_TZPC_AO_DECPROT2SET_mmbuf_firewall_START (0)
#define SOC_TZPC_AO_DECPROT2SET_mmbuf_firewall_END (15)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_TZPC_AO_DECPROT2CLR_mmbuf_firewall_START (0)
#define SOC_TZPC_AO_DECPROT2CLR_mmbuf_firewall_END (15)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_TZPC_AO_DECPROT4STAT_ocbc_START (0)
#define SOC_TZPC_AO_DECPROT4STAT_ocbc_END (0)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_TZPC_AO_DECPROT4SET_ocbc_START (0)
#define SOC_TZPC_AO_DECPROT4SET_ocbc_END (0)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_TZPC_AO_DECPROT4CLR_ocbc_START (0)
#define SOC_TZPC_AO_DECPROT4CLR_ocbc_END (0)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
