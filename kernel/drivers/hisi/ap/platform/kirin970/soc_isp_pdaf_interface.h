...
#define SOC_ISP_PDAF_PDAF_CFG_FILTER_ADDR(base) ((base) + (0x104))
...
typedef union
{
    ...
    struct
    {
        unsigned int pdaf_gain_en : 1;
        unsigned int pdaf_directional_en : 1;
        unsigned int reserved : 30;
    } reg;
} SOC_ISP_PDAF_PDAF_CTRL_UNION;
#endif
#define SOC_ISP_PDAF_PDAF_CTRL_pdaf_gain_en_START (0)
#define SOC_ISP_PDAF_PDAF_CTRL_pdaf_gain_en_END (0)
#define SOC_ISP_PDAF_PDAF_CTRL_pdaf_directional_en_START (1)
#define SOC_ISP_PDAF_PDAF_CTRL_pdaf_directional_en_END (1)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        unsigned int pxdiffthr : 14;
        unsigned int reserved_0: 2;
        unsigned int mul : 6;
        unsigned int reserved_1: 9;
        unsigned int cor_ave : 1;
    } reg;
} SOC_ISP_PDAF_PDAF_CFG_FILTER_UNION;
#endif
#define SOC_ISP_PDAF_PDAF_CFG_FILTER_pxdiffthr_START (0)
#define SOC_ISP_PDAF_PDAF_CFG_FILTER_pxdiffthr_END (13)
#define SOC_ISP_PDAF_PDAF_CFG_FILTER_mul_START (16)
#define SOC_ISP_PDAF_PDAF_CFG_FILTER_mul_END (21)
#define SOC_ISP_PDAF_PDAF_CFG_FILTER_cor_ave_START (31)
#define SOC_ISP_PDAF_PDAF_CFG_FILTER_cor_ave_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
