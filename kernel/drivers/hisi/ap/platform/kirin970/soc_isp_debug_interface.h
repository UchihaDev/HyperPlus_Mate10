...
#define SOC_ISP_DEBUG_BPE_ILA_CTRL_ADDR(base) ((base) + (0x184))
#define SOC_ISP_DEBUG_FE_ILA_CTRL_ADDR(base) ((base) + (0x188))
#define SOC_ISP_DEBUG_DP_STATE_FE1_L32_ADDR(base) ((base) + (0x200))
#define SOC_ISP_DEBUG_DP_STATE_FE1_H32_ADDR(base) ((base) + (0x204))
#define SOC_ISP_DEBUG_DP_STATE_FE2_L32_ADDR(base) ((base) + (0x208))
#define SOC_ISP_DEBUG_DP_STATE_FE2_H32_ADDR(base) ((base) + (0x20C))
#define SOC_ISP_DEBUG_DP_STATE_BE1_L32_ADDR(base) ((base) + (0x210))
#define SOC_ISP_DEBUG_DP_STATE_BE1_H32_ADDR(base) ((base) + (0x214))
#define SOC_ISP_DEBUG_DP_STATE_BE2_L32_ADDR(base) ((base) + (0x218))
#define SOC_ISP_DEBUG_DP_STATE_BE2_H32_ADDR(base) ((base) + (0x21C))
#define SOC_ISP_DEBUG_DP_STATE_PE1_L32_ADDR(base) ((base) + (0x220))
#define SOC_ISP_DEBUG_DP_STATE_PE1_H32_ADDR(base) ((base) + (0x224))
#define SOC_ISP_DEBUG_DP_STATE_PE2_L32_ADDR(base) ((base) + (0x228))
#define SOC_ISP_DEBUG_DP_STATE_PE2_H32_ADDR(base) ((base) + (0x22C))
#define SOC_ISP_DEBUG_DP_STATE_OTHER1_L32_ADDR(base) ((base) + (0x230))
#define SOC_ISP_DEBUG_DP_STATE_OTHER1_H32_ADDR(base) ((base) + (0x234))
#define SOC_ISP_DEBUG_DP_STATE_OTHER2_L32_ADDR(base) ((base) + (0x238))
#define SOC_ISP_DEBUG_DP_STATE_OTHER2_H32_ADDR(base) ((base) + (0x23C))
#define SOC_ISP_DEBUG_DP_STATE_FE1_EN_ADDR(base) ((base) + (0x240))
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int dbg_top_rt_axi_sel : 1;
...
#define SOC_ISP_DEBUG_DBG_TOP_PROC_CFG_dbg_top_rt_axi_sel_START (8)
#define SOC_ISP_DEBUG_DBG_TOP_PROC_CFG_dbg_top_rt_axi_sel_END (8)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        unsigned int be1_ila_sel : 8;
        unsigned int be2_ila_sel : 8;
        unsigned int pe_ila_sel : 8;
        unsigned int reserved : 6;
        unsigned int bpe_ila_sel : 2;
    } reg;
} SOC_ISP_DEBUG_BPE_ILA_CTRL_UNION;
#endif
#define SOC_ISP_DEBUG_BPE_ILA_CTRL_be1_ila_sel_START (0)
#define SOC_ISP_DEBUG_BPE_ILA_CTRL_be1_ila_sel_END (7)
#define SOC_ISP_DEBUG_BPE_ILA_CTRL_be2_ila_sel_START (8)
#define SOC_ISP_DEBUG_BPE_ILA_CTRL_be2_ila_sel_END (15)
#define SOC_ISP_DEBUG_BPE_ILA_CTRL_pe_ila_sel_START (16)
#define SOC_ISP_DEBUG_BPE_ILA_CTRL_pe_ila_sel_END (23)
#define SOC_ISP_DEBUG_BPE_ILA_CTRL_bpe_ila_sel_START (30)
#define SOC_ISP_DEBUG_BPE_ILA_CTRL_bpe_ila_sel_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int fe1_ila_sel : 8;
        unsigned int fe2_ila_sel : 8;
        unsigned int reserved : 16;
    } reg;
} SOC_ISP_DEBUG_FE_ILA_CTRL_UNION;
#endif
#define SOC_ISP_DEBUG_FE_ILA_CTRL_fe1_ila_sel_START (0)
#define SOC_ISP_DEBUG_FE_ILA_CTRL_fe1_ila_sel_END (7)
#define SOC_ISP_DEBUG_FE_ILA_CTRL_fe2_ila_sel_START (8)
#define SOC_ISP_DEBUG_FE_ILA_CTRL_fe2_ila_sel_END (15)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int fe1_dp_state_l32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_FE1_L32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_FE1_L32_fe1_dp_state_l32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_FE1_L32_fe1_dp_state_l32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int fe1_dp_state_h32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_FE1_H32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_FE1_H32_fe1_dp_state_h32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_FE1_H32_fe1_dp_state_h32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int fe2_dp_state_l32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_FE2_L32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_FE2_L32_fe2_dp_state_l32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_FE2_L32_fe2_dp_state_l32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int fe2_dp_state_h32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_FE2_H32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_FE2_H32_fe2_dp_state_h32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_FE2_H32_fe2_dp_state_h32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int be1_dp_state_l32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_BE1_L32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_BE1_L32_be1_dp_state_l32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_BE1_L32_be1_dp_state_l32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int be1_dp_state_h32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_BE1_H32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_BE1_H32_be1_dp_state_h32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_BE1_H32_be1_dp_state_h32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int be2_dp_state_l32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_BE2_L32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_BE2_L32_be2_dp_state_l32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_BE2_L32_be2_dp_state_l32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int be2_dp_state_h32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_BE2_H32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_BE2_H32_be2_dp_state_h32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_BE2_H32_be2_dp_state_h32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int pe1_dp_state_l32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_PE1_L32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_PE1_L32_pe1_dp_state_l32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_PE1_L32_pe1_dp_state_l32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int pe1_dp_state_h32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_PE1_H32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_PE1_H32_pe1_dp_state_h32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_PE1_H32_pe1_dp_state_h32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int pe2_dp_state_l32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_PE2_L32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_PE2_L32_pe2_dp_state_l32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_PE2_L32_pe2_dp_state_l32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int pe2_dp_state_h32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_PE2_H32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_PE2_H32_pe2_dp_state_h32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_PE2_H32_pe2_dp_state_h32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int other1_dp_state_l32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_OTHER1_L32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_OTHER1_L32_other1_dp_state_l32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_OTHER1_L32_other1_dp_state_l32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int other1_dp_state_h32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_OTHER1_H32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_OTHER1_H32_other1_dp_state_h32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_OTHER1_H32_other1_dp_state_h32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int other2_dp_state_l32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_OTHER2_L32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_OTHER2_L32_other2_dp_state_l32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_OTHER2_L32_other2_dp_state_l32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int other2_dp_state_h32 : 32;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_OTHER2_H32_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_OTHER2_H32_other2_dp_state_h32_START (0)
#define SOC_ISP_DEBUG_DP_STATE_OTHER2_H32_other2_dp_state_h32_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int fe1_state_debug_en : 1;
        unsigned int reserved_0 : 3;
        unsigned int fe2_state_debug_en : 1;
        unsigned int reserved_1 : 3;
        unsigned int be1_state_debug_en : 1;
        unsigned int reserved_2 : 3;
        unsigned int be2_state_debug_en : 1;
        unsigned int reserved_3 : 3;
        unsigned int pe1_state_debug_en : 1;
        unsigned int reserved_4 : 7;
        unsigned int pe2_state_debug_en : 1;
        unsigned int reserved_5 : 3;
        unsigned int reserved_6 : 4;
    } reg;
} SOC_ISP_DEBUG_DP_STATE_FE1_EN_UNION;
#endif
#define SOC_ISP_DEBUG_DP_STATE_FE1_EN_fe1_state_debug_en_START (0)
#define SOC_ISP_DEBUG_DP_STATE_FE1_EN_fe1_state_debug_en_END (0)
#define SOC_ISP_DEBUG_DP_STATE_FE1_EN_fe2_state_debug_en_START (4)
#define SOC_ISP_DEBUG_DP_STATE_FE1_EN_fe2_state_debug_en_END (4)
#define SOC_ISP_DEBUG_DP_STATE_FE1_EN_be1_state_debug_en_START (8)
#define SOC_ISP_DEBUG_DP_STATE_FE1_EN_be1_state_debug_en_END (8)
#define SOC_ISP_DEBUG_DP_STATE_FE1_EN_be2_state_debug_en_START (12)
#define SOC_ISP_DEBUG_DP_STATE_FE1_EN_be2_state_debug_en_END (12)
#define SOC_ISP_DEBUG_DP_STATE_FE1_EN_pe1_state_debug_en_START (16)
#define SOC_ISP_DEBUG_DP_STATE_FE1_EN_pe1_state_debug_en_END (16)
#define SOC_ISP_DEBUG_DP_STATE_FE1_EN_pe2_state_debug_en_START (24)
#define SOC_ISP_DEBUG_DP_STATE_FE1_EN_pe2_state_debug_en_END (24)
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
