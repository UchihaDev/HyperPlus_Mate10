...
#define PLATFORM_ID_BIT_KIRIN980_ES  (6U)
...
static struct noc_platform_info g_noc_platform_info[] = {
	...
	/*hisi platform: kirin980_es */
	[6] = {
	       .name = "kirin980_es",
	       .platform_id = 1 << PLATFORM_ID_BIT_KIRIN980_ES,	/* must be same as the value defined in DTS. */
	       .p_noc_info_bus = noc_buses_info_kirin980_es,
	       .p_noc_info_dump = noc_dump_reg_list_kirin980_es,
	       .p_noc_info_filter_initflow = hisi_filter_initflow_kirin980_es,
	       .pfun_get_size = hisi_noc_get_array_size_kirin980_es,
	       .pfun_clock_enable = hisi_noc_clock_enable_kirin980_es,
	       }
};
