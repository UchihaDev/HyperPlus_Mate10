...
struct noc_mid_info noc_mid_kirin980_es[] = {
...
struct noc_sec_info noc_sec_kirin980_es[] = {
...
struct noc_dump_reg noc_dump_reg_list_kirin980_es[] = {
	...
	{"PMCTRL", (void *)NULL, 0x3AC},//PMCTRL_PERI_INT1_STAT},
	...
	{"CRGPERIPH", (void *)NULL, 0xc88},//CRGPERIPH_ISP_SEC_RSTSTAT},
	{"CRGPERIPH", (void *)NULL, 0xc04},//CRGPERIPH_IVP_SEC_RSTDIS},
 ...
 */
const struct noc_busid_initflow hisi_filter_initflow_kirin980_es[] = {
...
const struct noc_bus_info noc_buses_info_kirin980_es[] = {
	[0] = {
		...
		.p_noc_mid_info = noc_mid_kirin980_es,
		.noc_mid_info_size = ARRAY_SIZE_NOC(noc_mid_kirin980_es),
		.p_noc_sec_info = noc_sec_kirin980_es,
		.noc_sec_info_size = ARRAY_SIZE_NOC(noc_sec_kirin980_es),
	},
	[1] = {
		.name = "vcodec_bus",
 ...
 */
void hisi_noc_get_array_size_kirin980_es(unsigned int *bus_info_size, unsigned int *dump_list_size)
{
	if ((NULL == bus_info_size)||(NULL == dump_list_size))
		return;

	*bus_info_size  = ARRAY_SIZE_NOC(noc_buses_info_kirin980_es);
	*dump_list_size = ARRAY_SIZE_NOC(noc_dump_reg_list_kirin980_es);
}
 ...
 */
unsigned int hisi_noc_clock_enable_kirin980_es(struct hisi_noc_device *noc_dev,
