...
#define SOC_HDLC_FRM_INFO_MAX_LEN_ADDR(base) ((base) + (0x0058))
...
#define SOC_HDLC_DEF_INFO_MAX_LEN_ADDR(base) ((base) + (0x00C8))
#define SOC_HDLC_DEF_INFO_TOOLONG_LEN_ADDR(base) ((base) + (0x00CC))
#define SOC_HDLC_VERSION_ADDR(base) ((base) + (0x00FC))
...
typedef union
{
    ...
    struct
    {
        unsigned int frm_info_max_len : 16;
        unsigned int reserved : 16;
    } reg;
} SOC_HDLC_FRM_INFO_MAX_LEN_UNION;
#endif
#define SOC_HDLC_FRM_INFO_MAX_LEN_frm_info_max_len_START (0)
#define SOC_HDLC_FRM_INFO_MAX_LEN_frm_info_max_len_END (15)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        unsigned int def_info_max_len : 11;
        unsigned int reserved_0 : 21;
    } reg;
} SOC_HDLC_DEF_INFO_MAX_LEN_UNION;
#endif
#define SOC_HDLC_DEF_INFO_MAX_LEN_def_info_max_len_START (0)
#define SOC_HDLC_DEF_INFO_MAX_LEN_def_info_max_len_END (10)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int def_info_toolong_len : 11;
        unsigned int reserved_0 : 21;
    } reg;
} SOC_HDLC_DEF_INFO_TOOLONG_LEN_UNION;
#endif
#define SOC_HDLC_DEF_INFO_TOOLONG_LEN_def_info_toolong_len_START (0)
#define SOC_HDLC_DEF_INFO_TOOLONG_LEN_def_info_toolong_len_END (10)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
} SOC_HDLC_VERSION_UNION;
#endif
#define SOC_HDLC_VERSION_version_START (0)
#define SOC_HDLC_VERSION_version_END (31)
...
#define SOC_ARM_HDLC_FRM_INFO_MAX_LEN_ADDR(BaseAddr) SOC_HDLC_FRM_INFO_MAX_LEN_ADDR(BaseAddr)
...
#define SOC_ARM_HDLC_DEF_INFO_MAX_LEN_ADDR(BaseAddr) SOC_HDLC_DEF_INFO_MAX_LEN_ADDR(BaseAddr)
#define SOC_ARM_HDLC_DEF_INFO_TOOLONG_LEN_ADDR(BaseAddr) SOC_HDLC_DEF_INFO_TOOLONG_LEN_ADDR(BaseAddr)
#define SOC_ARM_HDLC_VERSION_ADDR(BaseAddr) SOC_HDLC_VERSION_ADDR(BaseAddr)
#else
